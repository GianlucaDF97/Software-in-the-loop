 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jun 03 11:22:21 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Seriale_mav
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        inutile
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       Messaggio
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       serial_available
...
{
    const uint8_T *inutile = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    uint8_T *Messaggio = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    int32_T *serial_available = (int32_T *) ssGetOutputPortRealSignal(S, 1);
    const real_T *xD = ssGetDiscStates(S);

    Seriale_mav_Outputs_wrapper(inutile, Messaggio, serial_available, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Seriale_mav_Update_wrapper(inutile, Messaggio, serial_available, xD);
