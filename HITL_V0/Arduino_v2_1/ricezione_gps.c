 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Oct 08 18:28:25 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ricezione_gps
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ricezione_gps_Start_wrapper(SimStruct *S);
extern void ricezione_gps_Outputs_wrapper(const uint8_T *u0,
			SimStruct *S);
extern void ricezione_gps_Terminate_wrapper(SimStruct *S);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ricezione_gps_Outputs_wrapper(u0, S);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    ricezione_gps_Terminate_wrapper(S);
