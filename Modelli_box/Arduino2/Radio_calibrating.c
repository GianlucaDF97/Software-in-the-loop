...
#define S_FUNCTION_NAME Radio_calibrating
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        manetta
...
/* Input Port  1 */
#define IN_PORT_1_NAME        equilibratore
...
/* Input Port  2 */
#define IN_PORT_2_NAME        alettoni
...
/* Input Port  4 */
#define IN_PORT_4_NAME        cal_start
#define INPUT_4_WIDTH         1
#define INPUT_DIMS_4_COL      1
#define INPUT_4_DTYPE         int8_T
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       pwm_manetta_max
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       pwm_manetta_min
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       pwm_equilibratore_max
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       pwm_equilibratore_min
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       pwm_alettoni_max
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       pwm_alettoni_min
...
/* Output Port  6 */
#define OUT_PORT_6_NAME       pwm_timone_max
...
/* Output Port  7 */
#define OUT_PORT_7_NAME       pwm_timone_min
...
/* Output Port  8 */
#define OUT_PORT_8_NAME       proceed
#define OUTPUT_8_WIDTH        1
#define OUTPUT_DIMS_8_COL     1
#define OUTPUT_8_DTYPE        int8_T
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetOutputPortDataType(S, 8, SS_INT8);
...
{
    const real_T *manetta = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *equilibratore = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *alettoni = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *timone = (real_T *) ssGetInputPortRealSignal(S, 3);
    const int8_T *cal_start = (int8_T *) ssGetInputPortRealSignal(S, 4);
    real_T *pwm_manetta_max = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *pwm_manetta_min = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *pwm_equilibratore_max = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *pwm_equilibratore_min = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *pwm_alettoni_max = (real_T *) ssGetOutputPortRealSignal(S, 4);
    real_T *pwm_alettoni_min = (real_T *) ssGetOutputPortRealSignal(S, 5);
    real_T *pwm_timone_max = (real_T *) ssGetOutputPortRealSignal(S, 6);
    real_T *pwm_timone_min = (real_T *) ssGetOutputPortRealSignal(S, 7);
    int8_T *proceed = (int8_T *) ssGetOutputPortRealSignal(S, 8);
    const real_T *xD = ssGetDiscStates(S);

    Radio_calibrating_Outputs_wrapper(manetta, equilibratore, alettoni, timone, cal_start, pwm_manetta_max, pwm_manetta_min, pwm_equilibratore_max, pwm_equilibratore_min, pwm_alettoni_max, pwm_alettoni_min, pwm_timone_max, pwm_timone_min, proceed, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Radio_calibrating_Update_wrapper(manetta, equilibratore, alettoni, timone, cal_start, pwm_manetta_max, pwm_manetta_min, pwm_equilibratore_max, pwm_equilibratore_min, pwm_alettoni_max, pwm_alettoni_min, pwm_timone_max, pwm_timone_min, proceed, xD);
