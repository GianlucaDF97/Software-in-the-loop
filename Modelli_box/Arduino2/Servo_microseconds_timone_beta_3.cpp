/*
 * File: Servo_microseconds_timone_beta_3.cpp
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue May 10 11:54:53 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Servo_microseconds_timone_beta_3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Servo_microseconds_timone_beta_3_Outputs_wrapper(const int16_T *tau,
			const real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Servo_microseconds_timone_beta_3_Outputs_wrapper(tau, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Servo_microseconds_timone_beta_3_Update_wrapper(tau, xD);
