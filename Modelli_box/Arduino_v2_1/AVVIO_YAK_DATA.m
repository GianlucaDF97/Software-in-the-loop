...
attuatore_Amin = deg2rad(-20);
attuatore_Emax = deg2rad(25);
attuatore_Emin = deg2rad(-25);
attuatore_Rmax = deg2rad(25);
attuatore_Rmin = deg2rad(-25);
attuatore_Tmax = 0.4;
attuatore_Tmin = 0;
...
Kp_becch = -0.1918;                      % Kp controllore beccheggio
Ki_becch = -0.064065;                    % Ki controllore beccheggio
Kp_q = -0.025;                           % Kp controllore velocita beccheggio
Kp_comp_h = 0.035;

Kp_roll = 0.11;                          % Kp controllore rollio
Ki_roll = 0.025;                         % Ki controllore rollio
Kp_p = 0.025;                            % Kp controllore velocita rollio

Kp_imb = -0.04;                         % Kp controllore imbardata

Kp_AP_vel = 0.02692;                      % Kp controllore velocita
Ki_AP_vel = 0.001;                       % Kp controllore velocita

Kp_AP_quota_hold_h = 0.15;                  % Kp controllore quota ad alte velocita
Kp_AP_quota_hold_l = 0.7;                    % Kp controllore quota a basse velocita
