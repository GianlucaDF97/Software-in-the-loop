/*
 * File: SImulate_messageGPS_nmea_carriage_return.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon May 31 19:02:38 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SImulate_messageGPS_nmea_carriage_return
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       GPSmsg
#define OUTPUT_0_WIDTH        131
...
extern void SImulate_messageGPS_nmea_carriage_return_Outputs_wrapper(const real_T *Lat,
			const real_T *Long,
			const real_T *V_,
...
{
    const real_T *Lat = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *Long = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *V_ = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *heading = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *h = (real_T *) ssGetInputPortRealSignal(S, 4);
    uint8_T *GPSmsg = (uint8_T *) ssGetOutputPortRealSignal(S, 0);

    SImulate_messageGPS_nmea_carriage_return_Outputs_wrapper(Lat, Long, V_, heading, h, GPSmsg);
