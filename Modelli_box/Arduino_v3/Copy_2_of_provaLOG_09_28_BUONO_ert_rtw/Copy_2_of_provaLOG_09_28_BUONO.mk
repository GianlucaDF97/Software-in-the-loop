###########################################################################
## Makefile generated for component 'Copy_2_of_provaLOG_09_28_BUONO'. 
## 
## Makefile     : Copy_2_of_provaLOG_09_28_BUONO.mk
## Generated on : Fri Nov 26 16:18:28 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_2_of_provaLOG_09_28_BUONO.elf
...
PRODUCT_NAME              = Copy_2_of_provaLOG_09_28_BUONO
MAKEFILE                  = Copy_2_of_provaLOG_09_28_BUONO.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_2_of_provaLOG_09_28_BUONO.elf
...
DEFINES_STANDARD = -DMODEL=Copy_2_of_provaLOG_09_28_BUONO -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o MW_arduinoI2C.o Copy_2_of_provaLOG_09_28_BUONO.o Copy_2_of_provaLOG_09_28_BUONO_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Mti_wrapper.o Seriale_mav_wrapper.o calc_T_wrapper.o calc_p_wrapper.o receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.o send_MAVLink_v4_4_2_beta_3_HOME_wrapper.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Copy_2_of_provaLOG_09_28_BUONO.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/Copy_2_of_provaLOG_09_28_BUONO.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_2_of_provaLOG_09_28_BUONO_data.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/Copy_2_of_provaLOG_09_28_BUONO_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_2_of_provaLOG_09_28_BUONO_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
