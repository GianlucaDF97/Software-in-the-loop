###########################################################################
## Makefile generated for component 'Copy_3_of_laod_arduino_2021'. 
## 
## Makefile     : Copy_3_of_laod_arduino_2021.mk
## Generated on : Wed Oct 13 18:44:36 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_3_of_laod_arduino_2021.elf
...
PRODUCT_NAME              = Copy_3_of_laod_arduino_2021
MAKEFILE                  = Copy_3_of_laod_arduino_2021.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_3_of_laod_arduino_2021.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/svd/include -I$(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/variants/arduino_due_x -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/SPI/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src/sam
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=8 -DMW_TIMERCOUNT=13125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=57600 -D_RTT_BAUDRATE_SERIAL1_=57600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Copy_3_of_laod_arduino_2021 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinobase/src/MW_SerialRead.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinobase/src/MW_SerialWrite.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/Copy_3_of_laod_arduino_2021.c $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/Copy_3_of_laod_arduino_2021_data.c $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rtGetInf.c $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rtGetNaN.c $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rt_nonfinite.c $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rt_zcfcn.c $(START_DIR)/Mti_wrapper.cpp $(START_DIR)/PWMinterrupt_aileron_v4_4_wrapper.c $(START_DIR)/calcInputAileron.c $(START_DIR)/PWMinterrupt_elevator_v4_4_wrapper.c $(START_DIR)/calcInputElevator.c $(START_DIR)/PWMinterrupt_goHome_wrapper.c $(START_DIR)/calcInput_go_Home.c $(START_DIR)/PWMinterrupt_rudder_v4_4_wrapper.c $(START_DIR)/calcInputRudder.c $(START_DIR)/PWMinterrupt_throttle_v4_4_wrapper.c $(START_DIR)/calcInputThrottle.c $(START_DIR)/Risoluzione_12bit_wrapper.cpp $(START_DIR)/Seriale_mav_wrapper.cpp $(START_DIR)/Servo_microseconds_alettoni_beta_3_wrapper.cpp $(START_DIR)/Servo.cpp $(START_DIR)/Servo_microseconds_equilibratore_beta_3_wrapper.cpp $(START_DIR)/Servo_microseconds_manetta_beta_3_wrapper.cpp $(START_DIR)/Servo_microseconds_timone_beta_3_wrapper.cpp $(START_DIR)/calc_T_wrapper.c $(START_DIR)/calc_p_wrapper.c $(START_DIR)/receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.c $(START_DIR)/send_MAVLink_v4_4_2_beta_3_HOME_wrapper.c C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arm_m3_cortex_handler.c C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoARMScheduler.cpp C:/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c

MAIN_SRC = $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Copy_3_of_laod_arduino_2021.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/Copy_3_of_laod_arduino_2021.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_3_of_laod_arduino_2021_data.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/Copy_3_of_laod_arduino_2021_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.o : $(START_DIR)/Copy_3_of_laod_arduino_2021_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
PWMinterrupt_aileron_v4_4_wrapper.o : $(START_DIR)/PWMinterrupt_aileron_v4_4_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


calcInputAileron.o : $(START_DIR)/calcInputAileron.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWMinterrupt_elevator_v4_4_wrapper.o : $(START_DIR)/PWMinterrupt_elevator_v4_4_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


calcInputElevator.o : $(START_DIR)/calcInputElevator.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWMinterrupt_goHome_wrapper.o : $(START_DIR)/PWMinterrupt_goHome_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


calcInput_go_Home.o : $(START_DIR)/calcInput_go_Home.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWMinterrupt_rudder_v4_4_wrapper.o : $(START_DIR)/PWMinterrupt_rudder_v4_4_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


calcInputRudder.o : $(START_DIR)/calcInputRudder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWMinterrupt_throttle_v4_4_wrapper.o : $(START_DIR)/PWMinterrupt_throttle_v4_4_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


calcInputThrottle.o : $(START_DIR)/calcInputThrottle.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Risoluzione_12bit_wrapper.o : $(START_DIR)/Risoluzione_12bit_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Servo_microseconds_alettoni_beta_3_wrapper.o : $(START_DIR)/Servo_microseconds_alettoni_beta_3_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Servo.o : $(START_DIR)/Servo.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Servo_microseconds_equilibratore_beta_3_wrapper.o : $(START_DIR)/Servo_microseconds_equilibratore_beta_3_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Servo_microseconds_manetta_beta_3_wrapper.o : $(START_DIR)/Servo_microseconds_manetta_beta_3_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Servo_microseconds_timone_beta_3_wrapper.o : $(START_DIR)/Servo_microseconds_timone_beta_3_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
