 ...
 *
 * File: Copy_3_of_laod_arduino_2021_private.h
 *
...
#ifndef RTW_HEADER_Copy_3_of_laod_arduino_2021_private_h_
#define RTW_HEADER_Copy_3_of_laod_arduino_2021_private_h_
#include "rtwtypes.h"
...
extern void uMultiWordShl(const uint32_T u1[], int32_T n1, uint32_T n2, uint32_T
  y[], int32_T n);
extern void Copy__EnabledSubsystem_Init(real_T *rty_u0,
  P_EnabledSubsystem_Copy_3_of__T *localP);
extern void Copy_3_of__EnabledSubsystem(uint8_T rtu_Enable, real_T rtu_Time,
  real_T *rty_u0, P_EnabledSubsystem_Copy_3_of__T *localP);
extern void Co_ResettableSubsystem_Init(DW_ResettableSubsystem_Copy_3_T *localDW,
  P_ResettableSubsystem_Copy_3__T *localP);
extern void C_ResettableSubsystem_Reset(DW_ResettableSubsystem_Copy_3_T *localDW,
  P_ResettableSubsystem_Copy_3__T *localP);
extern real_T Copy_3__ResettableSubsystem(uint8_T rtu_Reset,
  DW_ResettableSubsystem_Copy_3_T *localDW, P_ResettableSubsystem_Copy_3__T
  *localP, ZCE_ResettableSubsystem_Copy__T *localZCE);
extern void One_time_initializatio_Init(B_One_time_initialization_Cop_T *localB,
  DW_One_time_initialization_Co_T *localDW, P_One_time_initialization_Cop_T
  *localP);
extern void Cop_One_time_initialization(boolean_T rtu_Enable,
  B_One_time_initialization_Cop_T *localB, DW_One_time_initialization_Co_T
  *localDW, P_One_time_initialization_Cop_T *localP);
extern void One_time_initializatio_Term(DW_One_time_initialization_Co_T *localDW);

#endif                   /* RTW_HEADER_Copy_3_of_laod_arduino_2021_private_h_ */
