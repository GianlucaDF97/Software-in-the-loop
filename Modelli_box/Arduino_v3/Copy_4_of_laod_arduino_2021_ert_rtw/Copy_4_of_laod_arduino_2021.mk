###########################################################################
## Makefile generated for component 'Copy_4_of_laod_arduino_2021'. 
## 
## Makefile     : Copy_4_of_laod_arduino_2021.mk
## Generated on : Tue Oct 19 19:05:22 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_4_of_laod_arduino_2021.elf
...
PRODUCT_NAME              = Copy_4_of_laod_arduino_2021
MAKEFILE                  = Copy_4_of_laod_arduino_2021.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_4_of_laod_arduino_2021.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=8 -DMW_TIMERCOUNT=13125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=57600 -D_RTT_BAUDRATE_SERIAL3_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Copy_4_of_laod_arduino_2021 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Copy_4_of_laod_arduino_2021.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/Copy_4_of_laod_arduino_2021.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_4_of_laod_arduino_2021_data.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/Copy_4_of_laod_arduino_2021_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.o : $(START_DIR)/Copy_4_of_laod_arduino_2021_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
