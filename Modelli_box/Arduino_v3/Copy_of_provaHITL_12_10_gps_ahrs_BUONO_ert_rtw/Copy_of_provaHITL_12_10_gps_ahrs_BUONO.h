 ...
 *
 * File: Copy_of_provaHITL_12_10_gps_ahrs_BUONO.h
 *
...
#ifndef RTW_HEADER_Copy_of_provaHITL_12_10_gps_ahrs_BUONO_h_
#define RTW_HEADER_Copy_of_provaHITL_12_10_gps_ahrs_BUONO_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef Copy_of_provaHITL_12_10_gps_ahrs_BUONO_COMMON_INCLUDES_
#define Copy_of_provaHITL_12_10_gps_ahrs_BUONO_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif             /* Copy_of_provaHITL_12_10_gps_ahrs_BUONO_COMMON_INCLUDES_ */

#include "Copy_of_provaHITL_12_10_gps_ahrs_BUONO_types.h"
...
#define Copy_of_provaHITL_12_10_gps_ahrs_BUONO_M (Copy_of_provaHITL_12_10_gps__M)
...
typedef struct {
  ...
  codertarget_arduinobase_inter_T obj_k;/* '<S38>/I2C Read8' */
  codertarget_arduinobase_inter_T obj_n;/* '<S38>/I2C Read7' */
  codertarget_arduinobase_inter_T obj_g;/* '<S38>/I2C Read6' */
  codertarget_arduinobase_inter_T obj_j;/* '<S38>/I2C Read5' */
  codertarget_arduinobase_inter_T obj_d;/* '<S38>/I2C Read4' */
  codertarget_arduinobase_inter_T obj_c;/* '<S38>/I2C Read3' */
  codertarget_arduinobase_inter_T obj_k4;/* '<S38>/I2C Read2' */
  codertarget_arduinobase_inter_T obj_h;/* '<S38>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S38>/I2C Read11' */
  codertarget_arduinobase_inter_T obj_ns;/* '<S38>/I2C Read10' */
  codertarget_arduinobase_inter_T obj_n3;/* '<S38>/I2C Read1' */
  codertarget_arduinobase_inter_T obj_h5;/* '<S38>/I2C Read' */
  codertarget_arduinobase_int_h_T obj_m;/* '<S38>/I2C Write3' */
  codertarget_arduinobase_int_h_T obj_h0;/* '<S38>/I2C Write2' */
  codertarget_arduinobase_int_h_T obj_dj;/* '<S38>/I2C Write1' */
...
typedef struct {
  ...
  int32_T DataTypeConversion1_c;       /* '<S35>/Data Type  Conversion1' */
  int32_T DataTypeConversion_p;        /* '<S35>/Data Type  Conversion' */
  int32_T SFunctionBuilder_o2_p;       /* '<S35>/S-Function Builder' */
  ...
  B_One_time_initialization_Cop_T One_time_initialization;/* '<S3>/One_time_initialization' */
} B_Copy_of_provaHITL_12_10_gps_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_c2_T obj; /* '<S18>/Serial Transmit' */
  codertarget_arduinobase_int_c_T obj_m;/* '<S19>/Serial Receive1' */
  codertarget_arduinobase_inter_T obj_d;/* '<S35>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_m5;/* '<S35>/I2C Read1' */
  ...
  uint8_T is_active_c9_Copy_of_provaHITL_;/* '<S8>/Chart' */
  uint8_T i;                           /* '<S8>/Chart' */
  ...
  DW_One_time_initialization_Co_T One_time_initialization;/* '<S3>/One_time_initialization' */
} DW_Copy_of_provaHITL_12_10_gp_T;
...
struct P_Copy_of_provaHITL_12_10_gps_T_ {
  ...
  real_T Memory_InitialCondition;      /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_a;            /* Expression: 16
  ...
  real_T Constant4_Value;              /* Expression: 4
                                        ...
                                        */
  real_T Constant2_Value_p;            /* Expression: 16
                                        * Referenced by: '<S35>/Constant2'
                                        */
  real_T Constant3_Value_n;            /* Expression: 8
  ...
  real_T T_0_Value;                    /* Expression: 298
                                        ...
                                        */
  real_T Constant_Value_b;             /* Expression: 15
  ...
  real_T Constant_Value_g;             /* Expression: 1
                                        ...
                                        */
  real_T Constant1_Value_n;            /* Expression: 102000
  ...
  uint8_T Typefixed_wingAutopilotgeneric_[2];
                           ...
                           */
  P_One_time_initialization_Cop_T One_time_initialization;/* '<S3>/One_time_initialization' */
};

/* Real-time Model Data Structure */
struct tag_RTM_Copy_of_provaHITL_12__T {
...
extern P_Copy_of_provaHITL_12_10_gps_T Copy_of_provaHITL_12_10_gps_a_P;

/* Block signals (default storage) */
extern B_Copy_of_provaHITL_12_10_gps_T Copy_of_provaHITL_12_10_gps_a_B;

/* Block states (default storage) */
extern DW_Copy_of_provaHITL_12_10_gp_T Copy_of_provaHITL_12_10_gps__DW;

/* External data declarations for dependent source files */
extern const uint16_T Copy_of_provaHITL_12_10_gps_ahrs_BUONO_U16GND;/* uint16_T ground */

/* External function called from main */
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_SetEventsForThisBaseStep
  (boolean_T *eventFlags);

/* Model entry point functions */
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_SetEventsForThisBaseStep
  (boolean_T *eventFlags);
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_initialize(void);
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_step0(void);
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_step1(void);
extern void Copy_of_provaHITL_12_10_gps_ahrs_BUONO_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Copy_of_provaHITL_12_T *const Copy_of_provaHITL_12_10_gps__M;
 ...
 *
 * '<Root>' : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO'
 * '<S1>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR RX'
 * '<S2>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX'
 * '<S3>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280'
 * '<S4>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR RX/MATLAB Function1'
 * '<S5>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR RX/MATLAB Function2'
 * '<S6>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR RX/MATLAB Function3'
 * '<S7>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR RX/MATLAB Function4'
 * '<S8>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Enable '
 * '<S9>'   : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS'
 * '<S10>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Heartbeat'
 * '<S11>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/IMU & Attidude'
 * '<S12>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/If_subsystem'
 * '<S13>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Servo'
 * '<S14>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/SystemStatus'
 * '<S15>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/VFR'
 * '<S16>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Waypoints'
 * '<S17>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Enable /Chart'
 * '<S18>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Enable /Chart/sendbyte'
 * '<S19>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus'
 * '<S20>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus/Subsystem1'
 * '<S21>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus/Subsystem2'
 * '<S22>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus/Subsystem2/Create_message'
 * '<S23>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus/Subsystem2/Subsystem'
 * '<S24>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/GPS/GPS_Venus/Subsystem2/Subsystem/MATLAB Function'
 * '<S25>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Heartbeat/Alarm set'
 * '<S26>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/IMU & Attidude/MTi'
 * '<S27>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/If_subsystem/Subsystem'
 * '<S28>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/If_subsystem/iflogic_function'
 * '<S29>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Servo/Conversione'
 * '<S30>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S31>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S32>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S33>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/AIR TX/Waypoints/MATLAB Function'
 * '<S34>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/Dynamic rate limiter'
 * '<S35>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/Execution_loop'
 * '<S36>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/MATLAB Function'
 * '<S37>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/MATLAB Function1'
 * '<S38>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/One_time_initialization'
 * '<S39>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/Subsystem'
 * '<S40>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S41>'  : 'Copy_of_provaHITL_12_10_gps_ahrs_BUONO/BMP_280/Subsystem/Subsystem1'
 */
#endif                /* RTW_HEADER_Copy_of_provaHITL_12_10_gps_ahrs_BUONO_h_ */
