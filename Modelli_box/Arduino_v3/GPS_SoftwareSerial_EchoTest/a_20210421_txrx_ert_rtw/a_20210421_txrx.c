 ...
 * C/C++ source code generated on : Fri Jun 25 11:57:30 2021
 *
...
void a_20210421_txrx_step0(void)       /* Sample time: [0.02s, 0.0s] */
{
  ...
  /* S-Function (Mti): '<Root>/S-Function Builder1' */
  Mti_Outputs_wrapper(&a_20210421_txrx_B.SFunctionBuilder1_o1[0],
                      &a_20210421_txrx_B.SFunctionBuilder1_o2,
                      &a_20210421_txrx_DW.SFunctionBuilder1_DSTATE);
  ...
  /* Unpack: <Root>/Byte Unpack */
  {
    ...
    /* Output data type - uint8_T, size - 4 */
    {
      ...
      memcpy((uint8_T*)&a_20210421_txrx_B.ByteUnpack_o1[0], (uint8_T*)
             &a_20210421_txrx_B.SFunctionBuilder1_o1[0] + MW_inputPortOffset,
             MW_outputPortWidth);
    }
    ...
    /* Output data type - real32_T, size - 12 */
    {
      ...
      memcpy((uint8_T*)&a_20210421_txrx_B.ByteUnpack_o2[0], (uint8_T*)
             &a_20210421_txrx_B.SFunctionBuilder1_o1[0] + MW_inputPortOffset,
             MW_outputPortWidth);
    }
    ...
    /* Output data type - uint8_T, size - 1 */
    {
      ...
      memcpy((uint8_T*)&a_20210421_txrx_B.ByteUnpack_o3, (uint8_T*)
             &a_20210421_txrx_B.SFunctionBuilder1_o1[0] + MW_inputPortOffset,
             MW_outputPortWidth);
    }
  }
  ...
  {
    int_T i1;
    const real32_T *u0 = &a_20210421_txrx_B.ByteUnpack_o2[0];
    real32_T *y0 = &a_20210421_txrx_B.ByteReversal[0];
    for (i1=0; i1 < 12; i1++) {
      ((uint32_T *)&y0[i1])[0] =
  ...
  a_20210421_txrx_B.T_0 = a_20210421_txrx_DW.riferimenti[12];
   ...
   *  Gain: '<S13>/Gain'
   */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[0] =
    a_20210421_txrx_P.loaduint16_Value;
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[1] = (uint16_T)
   ...
   *  MATLAB Function: '<S1>/MATLAB Function1'
   */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[2] = (uint16_T)qY;
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[3] =
    a_20210421_txrx_B.SFunction_o11[6];
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[4] =
    a_20210421_txrx_B.SFunction_o11[2];
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[5] =
   ...
   */
  rtb_RateTransition = floor(a_20210421_txrx_P.Constant4_Value);
  if (rtIsNaN(rtb_RateTransition) || rtIsInf(rtb_RateTransition)) {
    rtb_RateTransition = 0.0;
  } else {
   ...
   */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[6] = (uint16_T)
    (rtb_RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
     -rtb_RateTransition : (int32_T)(uint16_T)rtb_RateTransition);
   ...
   *  DataTypeConversion: '<S13>/Data Type Conversion4'
   */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctio_d[7] = (uint16_T)
    (rtb_RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
     -rtb_RateTransition : (int32_T)(uint16_T)rtb_RateTransition);
  ...
  for (caso = 0; caso < 9; caso++) {
    /* Gain: '<S10>/Gain' */
    u = a_20210421_txrx_P.Gain_Gain_g * a_20210421_txrx_B.ByteReversal[caso];
    ...
    /* DataTypeConversion: '<S10>/Data Type Conversion' */
    a_20210421_txrx_B.DataTypeConversion_d[caso] = (int16_T)(u < 0.0F ? (int32_T)
      (int16_T)-(int16_T)(uint16_T)-u : (int32_T)(int16_T)(uint16_T)u);
  }
  ...
  rtb_RateTransition = a_20210421_txrx_P.Gain1_Gain *
    a_20210421_txrx_P.vSimulated1_Value;
  ...
  a_20210421_txrx_B.DataTypeConversion4 = (int16_T)(rtb_RateTransition < 0.0 ?
  ...
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[0] =
    a_20210421_txrx_B.ByteReversal[9];
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[3] =
    a_20210421_txrx_B.ByteReversal[3];
  ...
  /* SignalConversion generated from: '<S2>/S-Function' */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[1] =
    a_20210421_txrx_B.ByteReversal[10];
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[4] =
    a_20210421_txrx_B.ByteReversal[4];
  ...
  /* SignalConversion generated from: '<S2>/S-Function' */
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[2] =
    a_20210421_txrx_B.ByteReversal[11];
  a_20210421_txrx_B.TmpSignalConversionAtSFunctionI[5] =
    a_20210421_txrx_B.ByteReversal[5];
   ...
   *  Gain: '<S2>/Pa to hPa1'
   */
  a_20210421_txrx_B.DataTypeConversion1 = (real32_T)
  ...
  send_MAVLink_v4_4_2_beta_3_HOME_Outputs_wrapper(&a_20210421_txrx_B.iflogic,
    ...
    &a_20210421_txrx_B.DataTypeConversion4,
    ...
    &a_20210421_txrx_B.SFunction_o14, &a_20210421_txrx_B.T_0,
    &a_20210421_txrx_B.SFunction_o15, &a_20210421_txrx_B.DataTypeConversion_m,
    &a_20210421_txrx_B.DataTypeConversion1,
    &a_20210421_txrx_B.DataTypeConversion2_b, &a_20210421_txrx_B.SFunction_o5[0],
    &a_20210421_txrx_P.Constant4_Value_i, &a_20210421_txrx_P.Constant5_Value,
  ...
  /* Update for S-Function (Mti): '<Root>/S-Function Builder1' */

  /* S-Function "Mti_wrapper" Block: <Root>/S-Function Builder1 */
  Mti_Update_wrapper(&a_20210421_txrx_B.SFunctionBuilder1_o1[0],
                     &a_20210421_txrx_B.SFunctionBuilder1_o2,
                     &a_20210421_txrx_DW.SFunctionBuilder1_DSTATE);
  ...
  for (caso = 0; caso < 7; caso++) {
    u = rt_roundf_snf(a_20210421_txrx_DW.riferimenti[caso]);
    if (u < 256.0F) {
      if (u >= 0.0F) {
        a_20210421_txrx_DW.Memory2_PreviousInput_k[caso + 2] = (uint8_T)u;
      } else {
...
void a_20210421_txrx_initialize(void)
{
...

  {
    ...
    /* Start for S-Function (Mti): '<Root>/S-Function Builder1' */

    /* S-Function Block: <Root>/S-Function Builder1 */
    Mti_Start_wrapper(&a_20210421_txrx_DW.SFunctionBuilder1_DSTATE);

    /* InitializeConditions for Memory: '<S1>/Memory4' */
    memcpy(&a_20210421_txrx_DW.Memory4_PreviousInput[0],
           &a_20210421_txrx_P.Memory4_InitialCondition[0], 300U * sizeof(uint8_T));

    /* InitializeConditions for S-Function (Mti): '<Root>/S-Function Builder1' */
    ...
    /* S-Function Block: <Root>/S-Function Builder1 */
    {
...

      {
        int_T i1;
        for (i1=0; i1 < 1; i1++) {
          a_20210421_txrx_DW.SFunctionBuilder1_DSTATE = initVector[0];
        }
      }
    }
...
{
  /* Terminate for S-Function (Mti): '<Root>/S-Function Builder1' */

  /* S-Function Block: <Root>/S-Function Builder1 */
  Mti_Terminate_wrapper(&a_20210421_txrx_DW.SFunctionBuilder1_DSTATE);
