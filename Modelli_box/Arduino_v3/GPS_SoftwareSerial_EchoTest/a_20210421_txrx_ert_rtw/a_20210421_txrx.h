...
typedef struct {
  ...
  real32_T ByteReversal[12];           /* '<Root>/Byte Reversal' */
  real_T poss_254[3];
  ...
  uint8_T SFunctionBuilder1_o1[53];    /* '<Root>/S-Function Builder1' */
  uint8_T SFunctionBuilder1_o2;        /* '<Root>/S-Function Builder1' */
