...
# Autogenerated on: 19-Jan-2013 14:27:30
# Model: PROVA2
# MyTemplate
# File name: prova2.mk
# Template: gmake 
...
MATLAB_ROOT_RELATIVE := ..\..\..\..\..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2012a\#MATLAB_ROOT_RELATIVE_END
MATLAB_ROOT_ABSOLUTE := C:\Program Files\MATLAB\R2012a\#MATLAB_ROOT_ABSOLUTE_END
...
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\rtiostream_serial.cpp) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\ext_serial_pkt.c) $(call FORMAT_PATH,.\ext_svr_serial_transport.c) $(call FORMAT_PATH,.\rtiostream_serial_interface.c) $(call FORMAT_PATH,.\prova19gennaio_wrapper.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\prova2.c) $(call FORMAT_PATH,.\prova2_data.c)
else
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\rtiostream_serial.cpp) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\ext_serial_pkt.c) $(call FORMAT_PATH,.\ext_svr_serial_transport.c) $(call FORMAT_PATH,.\rtiostream_serial_interface.c) $(call FORMAT_PATH,.\prova19gennaio_wrapper.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\prova2.c) $(call FORMAT_PATH,.\prova2_data.c)
endif

HEADER_FILES := $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\MATLAB\Targets\R2012a\arduino-1.0\hardware\arduino\cores\arduino\HardwareSerial.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\MATLAB\Targets\R2012a\arduino-1.0\hardware\arduino\cores\arduino\Print.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\MATLAB\Targets\R2012a\arduino-1.0\hardware\arduino\cores\arduino\WString.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\MATLAB\Targets\R2012a\arduino-1.0\hardware\arduino\cores\arduino\new.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2012a\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2012a\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2012a\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2012a\rtw\c\src\ext_mode\serial\ext_serial_pkt.h) $(call FORMAT_PATH,.\prova2.h)
...
COMPILER_CODEGEN_ARGS := -I"C:\\Users\\Vincenzo\\Desktop\\Tesi\\Vincenzo\\SENSORI\\XBee\\prove_simulazione\\IDE\\MAVLink\\ArduinoMAVLink_v1.0\\include_daga\\prova2_rtt" -I"C:\\Users\\Vincenzo\\Desktop\\Tesi\\Vincenzo\\SENSORI\\XBee\\prove_simulazione\\IDE\\MAVLink\\ArduinoMAVLink_v1.0\\include_daga" -I"C:\\Users\\Vincenzo\\Desktop\\Tesi\\Vincenzo\\SENSORI\\XBee\\prove_simulazione\\IDE\\MAVLink\\ArduinoMAVLink_v1.0" -I"C:\\Program Files\\MATLAB\\R2012a\\extern\\include" -I"C:\\Program Files\\MATLAB\\R2012a\\simulink\\include" -I"C:\\Program Files\\MATLAB\\R2012a\\rtw\\c\\src" -I"C:\\Program Files\\MATLAB\\R2012a\\rtw\\c\\src\\ext_mode\\common" -I"C:\\Program Files\\MATLAB\\R2012a\\rtw\\c\\ert" -I"C:\\MATLAB\\Targets\\R2012a\\arduino-1.0\\hardware\\arduino\\cores\\arduino" -I"C:\\MATLAB\\Targets\\R2012a\\arduino-1.0\\hardware\\arduino\\variants\\mega" -I"C:\\MATLAB\\Targets\\R2012a\\arduino\\include" -I"C:\\MATLAB\\Targets\\R2012a\\arduino-1.0\\libraries\\Servo" -I"C:\\Program Files\\MATLAB\\R2012a\\rtw\\c\\src\\ext_mode\\serial" -mmcu=atmega2560 -std=gnu99 -Wall -Wstrict-prototypes -gstabs -Os -D"MODEL=prova2" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"TID01EQ=0" -D"F_CPU=16000000" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_ROTH_MEGA2560_=" -D"_RTT_NUMSERVOS_=0" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLEPRINTF=" -D"EXTMODE_DISABLETESTING="

COMPILER_TCCFG_ARGS := -c -x none
COMPILER_ARGS := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)

LINKER_CODEGEN_ARGS :=  -lm -mmcu=atmega2560 -gstabs 
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  prova2.hex

EXECUTE_ARGS := 



COMPILER ?= $(subst \,/,C:\MATLAB\Targets\R2012a\arduino-1.0\hardware\tools\avr\bin\avr-gcc)

LINKER ?= $(subst \,/,C:\MATLAB\Targets\R2012a\arduino-1.0\hardware\tools\avr\bin\avr-gcc)

PREBUILD_TOOL ?= 

POSTBUILD_TOOL ?= $(subst \,/,C:\MATLAB\Targets\R2012a\arduino-1.0\hardware\tools\avr\bin\avr-objcopy)
