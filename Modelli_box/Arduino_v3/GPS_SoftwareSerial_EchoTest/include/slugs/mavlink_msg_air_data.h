 ...
 */
static __inline uint16_t mavlink_msg_air_data_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_air_data_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_air_data_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_air_data_t* air_data)
{
...
static __inline void mavlink_msg_air_data_send(mavlink_channel_t chan, float dynamicPressure, float staticPressure, uint16_t temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[10];
	_mav_put_float(buf, 0, dynamicPressure);
 ...
 */
static __inline float mavlink_msg_air_data_get_dynamicPressure(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_air_data_get_staticPressure(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_air_data_get_temperature(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_air_data_decode(const mavlink_message_t* msg, mavlink_air_data_t* air_data)
{
