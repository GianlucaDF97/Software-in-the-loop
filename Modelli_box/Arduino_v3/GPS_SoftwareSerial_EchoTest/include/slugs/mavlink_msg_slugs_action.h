 ...
 */
static __inline uint16_t mavlink_msg_slugs_action_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_slugs_action_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_slugs_action_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_slugs_action_t* slugs_action)
{
...
static __inline void mavlink_msg_slugs_action_send(mavlink_channel_t chan, uint8_t target, uint8_t actionId, uint16_t actionVal)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[4];
	_mav_put_uint16_t(buf, 0, actionVal);
 ...
 */
static __inline uint8_t mavlink_msg_slugs_action_get_target(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_slugs_action_get_actionId(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_slugs_action_get_actionVal(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_slugs_action_decode(const mavlink_message_t* msg, mavlink_slugs_action_t* slugs_action)
{
