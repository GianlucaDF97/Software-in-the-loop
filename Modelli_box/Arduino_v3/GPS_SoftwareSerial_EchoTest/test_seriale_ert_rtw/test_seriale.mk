###########################################################################
## Makefile generated for component 'test_seriale'. 
## 
## Makefile     : test_seriale.mk
## Generated on : Mon Jun 21 17:40:37 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_seriale.elf
...
PRODUCT_NAME              = test_seriale
MAKEFILE                  = test_seriale.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/SUBTEA~1/SOFTWARE/AUTOPI~1/AUTOPI~1/AHRS_H~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_seriale.elf
...
DEFINES_STANDARD = -DMODEL=test_seriale -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o test_seriale.o test_seriale_data.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/test_seriale_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/test_seriale_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/test_seriale_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/test_seriale_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/test_seriale_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/test_seriale_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_seriale.o : $(START_DIR)/test_seriale_ert_rtw/test_seriale.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_seriale_data.o : $(START_DIR)/test_seriale_ert_rtw/test_seriale_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
