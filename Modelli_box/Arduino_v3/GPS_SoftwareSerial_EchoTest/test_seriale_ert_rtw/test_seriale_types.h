 ...
 *
 * File: test_seriale_types.h
 *
 * Code generated for Simulink model 'test_seriale'.
 *
 * Model version                  : 1.2
 * Simulink Coder version         : 9.4 (R2020b) 29-Jul-2020
 * C/C++ source code generated on : Mon Jun 21 18:28:07 2021
 *
...
#ifndef RTW_HEADER_test_seriale_types_h_
#define RTW_HEADER_test_seriale_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_test_seriale_T
#define typedef_cell_wrap_test_seriale_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_test_seriale_T;

#endif                                 /*typedef_cell_wrap_test_seriale_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_test_seriale_T inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_int_n_T;

#endif                               /*typedef_codertarget_arduinobase_int_n_T*/

/* Parameters (default storage) */
typedef struct P_test_seriale_T_ P_test_seriale_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_test_seriale_T RT_MODEL_test_seriale_T;

#endif                                 /* RTW_HEADER_test_seriale_types_h_ */
