...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_07_09_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_07_09_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LOG_DATI_GPS_BMP_07_09_COMMON_INCLUDES_
#define LOG_DATI_GPS_BMP_07_09_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                             /* LOG_DATI_GPS_BMP_07_09_COMMON_INCLUDES_ */

#include "LOG_DATI_GPS_BMP_07_09_types.h"
...
} B_LOG_DATI_GPS_BMP_07_09_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_ac_T obj; /* '<S2>/Serial Transmit' */
  codertarget_arduinobase_in_ac_T obj_a;/* '<S23>/Serial Transmit' */
  codertarget_arduinobase_inter_T obj_d;/* '<S33>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S33>/I2C Read1' */
  codertarget_arduinobase_int_a_T obj_l;/* '<Root>/Serial Receive1' */
...
struct P_LOG_DATI_GPS_BMP_07_09_T_ {
  ...
  real_T Gain_Gain_mk;                 /* Expression: 100
                                        ...
                                        */
  real_T Constant6_Value_k;            /* Expression: 30
  ...
  uint16_T Memory_InitialCondition_h;
                                 ...
                                 */
  uint16_T Constant_Value_ja;          /* Computed Parameter: Constant_Value_ja
                                        * Referenced by: '<S2>/Constant'
                                        */
  uint16_T Constant3_Value_n;          /* Computed Parameter: Constant3_Value_n
                                        * Referenced by: '<S2>/Constant3'
                                        */
  uint16_T Constant1_Value_px;         /* Computed Parameter: Constant1_Value_px
...
extern P_LOG_DATI_GPS_BMP_07_09_T LOG_DATI_GPS_BMP_07_09_P;

/* Block signals (default storage) */
extern B_LOG_DATI_GPS_BMP_07_09_T LOG_DATI_GPS_BMP_07_09_B;

/* Block states (default storage) */
extern DW_LOG_DATI_GPS_BMP_07_09_T LOG_DATI_GPS_BMP_07_09_DW;

/* External data declarations for dependent source files */
extern const uint16_T LOG_DATI_GPS_BMP_07_09_U16GND;/* uint16_T ground */

/* External function called from main */
extern void LOG_DATI_GPS_BMP_07_09_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void LOG_DATI_GPS_BMP_07_09_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void LOG_DATI_GPS_BMP_07_09_initialize(void);
extern void LOG_DATI_GPS_BMP_07_09_step0(void);
extern void LOG_DATI_GPS_BMP_07_09_step1(void);
extern void LOG_DATI_GPS_BMP_07_09_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LOG_DATI_GPS_BMP_07__T *const LOG_DATI_GPS_BMP_07_09_M;
 ...
 *
 * '<Root>' : 'LOG_DATI_GPS_BMP_07_09'
 * '<S1>'   : 'LOG_DATI_GPS_BMP_07_09/AIR RX'
 * '<S2>'   : 'LOG_DATI_GPS_BMP_07_09/AIR TX'
 * '<S3>'   : 'LOG_DATI_GPS_BMP_07_09/BMP_280'
 * '<S4>'   : 'LOG_DATI_GPS_BMP_07_09/Subsystem1'
 * '<S5>'   : 'LOG_DATI_GPS_BMP_07_09/Subsystem2'
 * '<S6>'   : 'LOG_DATI_GPS_BMP_07_09/AIR RX/MATLAB Function1'
 * '<S7>'   : 'LOG_DATI_GPS_BMP_07_09/AIR RX/MATLAB Function2'
 * '<S8>'   : 'LOG_DATI_GPS_BMP_07_09/AIR RX/MATLAB Function3'
 * '<S9>'   : 'LOG_DATI_GPS_BMP_07_09/AIR RX/MATLAB Function4'
 * '<S10>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Enable '
 * '<S11>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/GPS'
 * '<S12>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Heartbeat'
 * '<S13>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/IMU & Attidude'
 * '<S14>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/If_subsystem'
 * '<S15>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Radians to Degrees'
 * '<S16>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Radians to Degrees1'
 * '<S17>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Radians to Degrees2'
 * '<S18>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Servo'
 * '<S19>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/SystemStatus'
 * '<S20>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/VFR'
 * '<S21>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Waypoints'
 * '<S22>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Enable /Chart'
 * '<S23>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Enable /Chart/sendbyte'
 * '<S24>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Heartbeat/Alarm set'
 * '<S25>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/If_subsystem/Subsystem'
 * '<S26>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/If_subsystem/iflogic_function'
 * '<S27>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Servo/Conversione'
 * '<S28>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S29>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S30>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S31>'  : 'LOG_DATI_GPS_BMP_07_09/AIR TX/Waypoints/MATLAB Function'
 * '<S32>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/Dynamic rate limiter'
 * '<S33>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/Execution_loop'
 * '<S34>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/MATLAB Function'
 * '<S35>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/MATLAB Function1'
 * '<S36>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/One_time_initialization'
 * '<S37>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/T_0 switchj'
 * '<S38>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S39>'  : 'LOG_DATI_GPS_BMP_07_09/BMP_280/T_0 switchj/Subsystem1'
 * '<S40>'  : 'LOG_DATI_GPS_BMP_07_09/Subsystem2/Create_message'
 * '<S41>'  : 'LOG_DATI_GPS_BMP_07_09/Subsystem2/Subsystem'
 * '<S42>'  : 'LOG_DATI_GPS_BMP_07_09/Subsystem2/Subsystem/MATLAB Function'
 */
#endif                                /* RTW_HEADER_LOG_DATI_GPS_BMP_07_09_h_ */
