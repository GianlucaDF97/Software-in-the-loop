 ...
 *
 * File: LOG_DATI_GPS_BMP_07_119_term.h
 *
...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_07_119_term_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_07_119_term_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LOG_DATI_GPS_BMP_07_119_term_COMMON_INCLUDES_
#define LOG_DATI_GPS_BMP_07_119_term_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                       /* LOG_DATI_GPS_BMP_07_119_term_COMMON_INCLUDES_ */

#include "LOG_DATI_GPS_BMP_07_119_term_types.h"
...
/* Block signals for system '<S32>/One_time_initialization' */
typedef struct {
  uint16_T ByteUnpack[8];              /* '<S37>/Byte Unpack' */
  uint16_T I2CRead3;                   /* '<S37>/I2C Read3' */
  uint16_T I2CRead;                    /* '<S37>/I2C Read' */
  int16_T I2CRead9;                    /* '<S37>/I2C Read9' */
  int16_T I2CRead8;                    /* '<S37>/I2C Read8' */
  int16_T I2CRead7;                    /* '<S37>/I2C Read7' */
  int16_T I2CRead6;                    /* '<S37>/I2C Read6' */
  int16_T I2CRead5;                    /* '<S37>/I2C Read5' */
  int16_T I2CRead4;                    /* '<S37>/I2C Read4' */
  int16_T I2CRead2;                    /* '<S37>/I2C Read2' */
  int16_T I2CRead11;                   /* '<S37>/I2C Read11' */
  int16_T I2CRead10;                   /* '<S37>/I2C Read10' */
  int16_T I2CRead1;                    /* '<S37>/I2C Read1' */
  uint8_T I2CRead12[16];               /* '<S37>/I2C Read12' */
} B_One_time_initialization_LOG_T;

/* Block states (default storage) for system '<S32>/One_time_initialization' */
typedef struct {
  codertarget_arduinobase_inter_T obj; /* '<S37>/I2C Read9' */
  codertarget_arduinobase_inter_T obj_l;/* '<S37>/I2C Read8' */
  codertarget_arduinobase_inter_T obj_b;/* '<S37>/I2C Read7' */
  codertarget_arduinobase_inter_T obj_m;/* '<S37>/I2C Read6' */
  codertarget_arduinobase_inter_T obj_n;/* '<S37>/I2C Read5' */
  codertarget_arduinobase_inter_T obj_i;/* '<S37>/I2C Read4' */
  codertarget_arduinobase_inter_T obj_o;/* '<S37>/I2C Read3' */
  codertarget_arduinobase_inter_T obj_ba;/* '<S37>/I2C Read2' */
  codertarget_arduinobase_inter_T obj_h;/* '<S37>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_p;/* '<S37>/I2C Read11' */
  codertarget_arduinobase_inter_T obj_f;/* '<S37>/I2C Read10' */
  codertarget_arduinobase_inter_T obj_d;/* '<S37>/I2C Read1' */
  codertarget_arduinobase_inter_T obj_n0;/* '<S37>/I2C Read' */
  codertarget_arduinobase_int_k_T obj_ff;/* '<S37>/I2C Write3' */
  codertarget_arduinobase_int_k_T obj_n4;/* '<S37>/I2C Write2' */
  codertarget_arduinobase_int_k_T obj_e;/* '<S37>/I2C Write1' */
...
typedef struct {
  ...
  char_T s1_data[81];
  char_T messaggio[80];
  uint8_T messaggio_c[80];             /* '<S42>/Create_message' */
  boolean_T messaggio_m[80];
  uint8_T NMEA_gga_string_data[79];
  char_T messaggio_data[79];
  real_T ComplextoRealImag[9];         /* '<S44>/Complex to Real-Imag' */
  uint8_T dataIn[67];
  ...
  real32_T ByteReversal[9];            /* '<S5>/Byte Reversal' */
  uint64m_T a;
  uint64m_T p16;
  uint64m_T sk;
  uint64m_T r3;
  ...
  real_T num_254;
  real_T UkYk1;                        /* '<S33>/Difference Inputs1' */
  real_T deltafalllimit;               /* '<S33>/delta fall limit' */
  ...
  real32_T DataTypeConversion3_m;      /* '<S32>/Data Type Conversion3' */
  ...
  real32_T T;                          /* '<S40>/T' */
  real32_T SFunctionBuilder_o1;        /* '<S34>/S-Function Builder' */
  ...
  int32_T DataTypeConversion1_l;       /* '<S34>/Data Type  Conversion1' */
  int32_T DataTypeConversion_p;        /* '<S34>/Data Type  Conversion' */
  int32_T SFunctionBuilder_o2_i;       /* '<S34>/S-Function Builder' */
  ...
  uint32_T SFunctionBuilder1;          /* '<S34>/S-Function Builder1' */
  real32_T ByteUnpack_o2[9];           /* '<S5>/Byte Unpack' */
  uint32_T qY;
  ...
  int16_T DataTypeConversion3_f[9];    /* '<S2>/Data Type Conversion3' */
  uint8_T SFunctionBuilder[41];        /* '<S5>/S-Function Builder' */
  uint8_T ByteUnpack_o1[4];            /* '<S5>/Byte Unpack' */
  uint8_T Memory_k[4];                 /* '<Root>/Memory' */
  uint16_T z;
  uint16_T x_d;
  uint8_T ByteUnpack_o3;               /* '<S5>/Byte Unpack' */
  ...
  uint8_T indice_dimario;              /* '<S44>/MATLAB Function' */
  uint8_T iflogic;                     /* '<S14>/iflogic_function' */
  uint8_T mess_out[100];               /* '<S1>/MATLAB Function2' */
  int8_T B_Remaining;                  /* '<S19>/Data Type Conversion3' */
  B_One_time_initialization_LOG_T One_time_initialization;/* '<S32>/One_time_initialization' */
} B_LOG_DATI_GPS_BMP_07_119_ter_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_bn_T obj; /* '<S2>/Serial Transmit1' */
  codertarget_arduinobase_in_bn_T obj_a;/* '<S23>/Serial Transmit' */
  codertarget_arduinobase_inter_T obj_d;/* '<S34>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S34>/I2C Read1' */
  codertarget_arduinobase_int_b_T obj_l;/* '<S4>/Serial Receive1' */
  real_T SFunctionBuilder_DSTATE;      /* '<S5>/S-Function Builder' */
  ...
  real_T Memory_PreviousInput_g[9];    /* '<S44>/Memory' */
  real_T P_ref;                        /* '<S32>/MATLAB Function' */
  real_T rl_up;                        /* '<S32>/MATLAB Function' */
  real_T rl_dw;                        /* '<S32>/MATLAB Function' */
  ...
  boolean_T UnitDelay_DSTATE;          /* '<S32>/Unit Delay' */
  ...
  uint8_T message[80];                 /* '<S42>/Create_message' */
  uint8_T counter_c;                   /* '<S42>/Create_message' */
  ...
  boolean_T start_found;               /* '<S42>/Create_message' */
  boolean_T end_found;                 /* '<S42>/Create_message' */
  ...
  DW_One_time_initialization_LO_T One_time_initialization;/* '<S32>/One_time_initialization' */
} DW_LOG_DATI_GPS_BMP_07_119_te_T;

/* Parameters for system: '<S32>/One_time_initialization' */
...
struct P_LOG_DATI_GPS_BMP_07_119_ter_T_ {
  ...
  real_T alt_r_Value;                  /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_h[4];               /* Expression: [10000;10000;1 ;1]
  ...
  real_T Constant_Value_a;             /* Expression: 1
                                        ...
                                        */
  real_T Constant1_Value_kc;           /* Expression: 102000
  ...
  real_T vsimulated_Value;             /* Expression: 20
                                        ...
                                        */
  real_T T_0_Value;                    /* Expression: 273.15+28.3
  ...
  real_T Constant10_Value;             /* Expression: 0
                                        ...
                                        */
  real_T Constant11_Value;             /* Expression: 23
  ...
  real_T Constant1_Value_px;           /* Expression: 1500
                                        ...
                                        */
  real_T Comandi_Value[4];             /* Expression: [0,0,0,0]
                                        * Referenced by: '<Root>/Comandi'
                                        */
  real_T PWMautopilota_Value[4];       /* Expression: [0,0,0,0]
  ...
  uint8_T FineMSG1_Value;              /* Computed Parameter: FineMSG1_Value
                                        ...
                                        */
  P_One_time_initialization_LOG_T One_time_initialization;/* '<S32>/One_time_initialization' */
};
...
extern P_LOG_DATI_GPS_BMP_07_119_ter_T LOG_DATI_GPS_BMP_07_119_term_P;

/* Block signals (default storage) */
extern B_LOG_DATI_GPS_BMP_07_119_ter_T LOG_DATI_GPS_BMP_07_119_term_B;

/* Block states (default storage) */
extern DW_LOG_DATI_GPS_BMP_07_119_te_T LOG_DATI_GPS_BMP_07_119_term_DW;

/* External data declarations for dependent source files */
extern const uint16_T LOG_DATI_GPS_BMP_07_119_term_U16GND;/* uint16_T ground */

/* External function called from main */
extern void LOG_DATI_GPS_BMP_07_119_term_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void LOG_DATI_GPS_BMP_07_119_term_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void LOG_DATI_GPS_BMP_07_119_term_initialize(void);
extern void LOG_DATI_GPS_BMP_07_119_term_step0(void);
extern void LOG_DATI_GPS_BMP_07_119_term_step1(void);
extern void LOG_DATI_GPS_BMP_07_119_term_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LOG_DATI_GPS_BMP_07__T *const LOG_DATI_GPS_BMP_07_119_term_M;
 ...
 *
 * '<Root>' : 'LOG_DATI_GPS_BMP_07_119_term'
 * '<S1>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR RX'
 * '<S2>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX'
 * '<S3>'   : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280'
 * '<S4>'   : 'LOG_DATI_GPS_BMP_07_119_term/GPS'
 * '<S5>'   : 'LOG_DATI_GPS_BMP_07_119_term/MTi'
 * '<S6>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR RX/MATLAB Function1'
 * '<S7>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR RX/MATLAB Function2'
 * '<S8>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR RX/MATLAB Function3'
 * '<S9>'   : 'LOG_DATI_GPS_BMP_07_119_term/AIR RX/MATLAB Function4'
 * '<S10>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Enable '
 * '<S11>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/GPS'
 * '<S12>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Heartbeat'
 * '<S13>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/IMU & Attidude'
 * '<S14>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/If_subsystem'
 * '<S15>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Radians to Degrees'
 * '<S16>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Radians to Degrees1'
 * '<S17>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Radians to Degrees2'
 * '<S18>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Servo'
 * '<S19>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/SystemStatus'
 * '<S20>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/VFR'
 * '<S21>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Waypoints'
 * '<S22>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Enable /Chart'
 * '<S23>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Enable /Chart/sendbyte'
 * '<S24>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Heartbeat/Alarm set'
 * '<S25>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/If_subsystem/Subsystem'
 * '<S26>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/If_subsystem/iflogic_function'
 * '<S27>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Servo/Conversione'
 * '<S28>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S29>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S30>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S31>'  : 'LOG_DATI_GPS_BMP_07_119_term/AIR TX/Waypoints/MATLAB Function'
 * '<S32>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280'
 * '<S33>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/Dynamic rate limiter'
 * '<S34>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/Execution_loop'
 * '<S35>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/MATLAB Function'
 * '<S36>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/MATLAB Function1'
 * '<S37>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/One_time_initialization'
 * '<S38>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/Subsystem'
 * '<S39>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S40>'  : 'LOG_DATI_GPS_BMP_07_119_term/BMP 280/BMP_280/Subsystem/Subsystem1'
 * '<S41>'  : 'LOG_DATI_GPS_BMP_07_119_term/GPS/Subsystem1'
 * '<S42>'  : 'LOG_DATI_GPS_BMP_07_119_term/GPS/Subsystem2'
 * '<S43>'  : 'LOG_DATI_GPS_BMP_07_119_term/GPS/Subsystem2/Create_message'
 * '<S44>'  : 'LOG_DATI_GPS_BMP_07_119_term/GPS/Subsystem2/Subsystem'
 * '<S45>'  : 'LOG_DATI_GPS_BMP_07_119_term/GPS/Subsystem2/Subsystem/MATLAB Function'
 */
#endif                          /* RTW_HEADER_LOG_DATI_GPS_BMP_07_119_term_h_ */
