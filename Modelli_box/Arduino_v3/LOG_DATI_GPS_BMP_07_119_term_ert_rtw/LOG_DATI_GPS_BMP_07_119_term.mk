###########################################################################
## Makefile generated for component 'LOG_DATI_GPS_BMP_07_119_term'. 
## 
## Makefile     : LOG_DATI_GPS_BMP_07_119_term.mk
## Generated on : Wed Jul 28 15:08:45 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LOG_DATI_GPS_BMP_07_119_term.elf
...
PRODUCT_NAME              = LOG_DATI_GPS_BMP_07_119_term
MAKEFILE                  = LOG_DATI_GPS_BMP_07_119_term.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LOG_DATI_GPS_BMP_07_119_term.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/svd/include -I$(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/variants/arduino_due_x -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/SPI/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src/sam
...
DEFINES_STANDARD = -DMODEL=LOG_DATI_GPS_BMP_07_119_term -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LOG_DATI_GPS_BMP_07_119_term.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/LOG_DATI_GPS_BMP_07_119_term.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LOG_DATI_GPS_BMP_07_119_term_data.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/LOG_DATI_GPS_BMP_07_119_term_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_119_term_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
