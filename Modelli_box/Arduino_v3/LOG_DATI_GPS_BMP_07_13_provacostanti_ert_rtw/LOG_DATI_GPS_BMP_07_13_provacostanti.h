 ...
 *
 * File: LOG_DATI_GPS_BMP_07_13_provacostanti.h
 *
...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_07_13_provacostanti_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_07_13_provacostanti_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LOG_DATI_GPS_BMP_07_13_provacostanti_COMMON_INCLUDES_
#define LOG_DATI_GPS_BMP_07_13_provacostanti_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif               /* LOG_DATI_GPS_BMP_07_13_provacostanti_COMMON_INCLUDES_ */

#include "LOG_DATI_GPS_BMP_07_13_provacostanti_types.h"
...
#define LOG_DATI_GPS_BMP_07_13_provacostanti_M (LOG_DATI_GPS_BMP_07_13_prova_M)
...
typedef struct {
  ...
  real_T DataTypeConversion11;         /* '<S2>/Data Type Conversion11' */
  ...
  uint16_T DataTypeConversion5_f[10];  /* '<S2>/Data Type Conversion5' */
  ...
  uint8_T BytePack[63];                /* '<S2>/Byte Pack' */
  uint8_T indice_dimario;              /* '<S41>/MATLAB Function' */
...
} B_LOG_DATI_GPS_BMP_07_13_prov_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_e3_T obj; /* '<S2>/Serial Transmit' */
  codertarget_arduinobase_in_e3_T obj_a;/* '<S23>/Serial Transmit' */
  codertarget_arduinobase_inter_T obj_d;/* '<S33>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S33>/I2C Read1' */
  codertarget_arduinobase_int_e_T obj_l;/* '<Root>/Serial Receive1' */
...
} DW_LOG_DATI_GPS_BMP_07_13_pro_T;
...
struct P_LOG_DATI_GPS_BMP_07_13_prov_T_ {
  ...
  real_T Constant12_Value;             /* Expression: 6
                                        ...
                                        */
  real_T Constant13_Value;             /* Expression: 7
                                        * Referenced by: '<S2>/Constant13'
                                        */
  real_T Constant14_Value;             /* Expression: 8
                                        * Referenced by: '<S2>/Constant14'
                                        */
  real_T Constant15_Value;             /* Expression: 9
                                        * Referenced by: '<S2>/Constant15'
                                        */
  real_T Constant16_Value;             /* Expression: 10
                                        * Referenced by: '<S2>/Constant16'
                                        */
  real_T Constant17_Value;             /* Expression: 11
...
extern P_LOG_DATI_GPS_BMP_07_13_prov_T LOG_DATI_GPS_BMP_07_13_provac_P;

/* Block signals (default storage) */
extern B_LOG_DATI_GPS_BMP_07_13_prov_T LOG_DATI_GPS_BMP_07_13_provac_B;

/* Block states (default storage) */
extern DW_LOG_DATI_GPS_BMP_07_13_pro_T LOG_DATI_GPS_BMP_07_13_prova_DW;

/* External data declarations for dependent source files */
extern const uint16_T LOG_DATI_GPS_BMP_07_13_provacostanti_U16GND;/* uint16_T ground */

/* External function called from main */
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_SetEventsForThisBaseStep
  (boolean_T *eventFlags);

/* Model entry point functions */
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_SetEventsForThisBaseStep
  (boolean_T *eventFlags);
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_initialize(void);
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_step0(void);
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_step1(void);
extern void LOG_DATI_GPS_BMP_07_13_provacostanti_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LOG_DATI_GPS_BMP_07__T *const LOG_DATI_GPS_BMP_07_13_prova_M;
 ...
 *
 * '<Root>' : 'LOG_DATI_GPS_BMP_07_13_provacostanti'
 * '<S1>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR RX'
 * '<S2>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX'
 * '<S3>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280'
 * '<S4>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/Subsystem1'
 * '<S5>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/Subsystem2'
 * '<S6>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR RX/MATLAB Function1'
 * '<S7>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR RX/MATLAB Function2'
 * '<S8>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR RX/MATLAB Function3'
 * '<S9>'   : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR RX/MATLAB Function4'
 * '<S10>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Enable '
 * '<S11>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/GPS'
 * '<S12>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Heartbeat'
 * '<S13>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/IMU & Attidude'
 * '<S14>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/If_subsystem'
 * '<S15>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Radians to Degrees'
 * '<S16>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Radians to Degrees1'
 * '<S17>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Radians to Degrees2'
 * '<S18>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Servo'
 * '<S19>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/SystemStatus'
 * '<S20>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/VFR'
 * '<S21>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Waypoints'
 * '<S22>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Enable /Chart'
 * '<S23>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Enable /Chart/sendbyte'
 * '<S24>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Heartbeat/Alarm set'
 * '<S25>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/If_subsystem/Subsystem'
 * '<S26>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/If_subsystem/iflogic_function'
 * '<S27>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Servo/Conversione'
 * '<S28>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S29>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S30>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S31>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/AIR TX/Waypoints/MATLAB Function'
 * '<S32>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/Dynamic rate limiter'
 * '<S33>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/Execution_loop'
 * '<S34>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/MATLAB Function'
 * '<S35>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/MATLAB Function1'
 * '<S36>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/One_time_initialization'
 * '<S37>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/Subsystem'
 * '<S38>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S39>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/BMP_280/Subsystem/Subsystem1'
 * '<S40>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/Subsystem2/Create_message'
 * '<S41>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/Subsystem2/Subsystem'
 * '<S42>'  : 'LOG_DATI_GPS_BMP_07_13_provacostanti/Subsystem2/Subsystem/MATLAB Function'
 */
#endif                  /* RTW_HEADER_LOG_DATI_GPS_BMP_07_13_provacostanti_h_ */
