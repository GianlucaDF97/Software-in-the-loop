###########################################################################
## Makefile generated for component 'LOG_DATI_GPS_BMP_07_14'. 
## 
## Makefile     : LOG_DATI_GPS_BMP_07_14.mk
## Generated on : Wed Jul 14 18:13:56 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LOG_DATI_GPS_BMP_07_14.elf
...
PRODUCT_NAME              = LOG_DATI_GPS_BMP_07_14
MAKEFILE                  = LOG_DATI_GPS_BMP_07_14.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LOG_DATI_GPS_BMP_07_14.elf
...
DEFINES_STANDARD = -DMODEL=LOG_DATI_GPS_BMP_07_14 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o MW_arduinoI2C.o LOG_DATI_GPS_BMP_07_14.o LOG_DATI_GPS_BMP_07_14_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Seriale_mav_wrapper.o calc_T_wrapper.o calc_p_wrapper.o receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.o send_MAVLink_v4_4_2_beta_3_HOME_wrapper.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LOG_DATI_GPS_BMP_07_14.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/LOG_DATI_GPS_BMP_07_14.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LOG_DATI_GPS_BMP_07_14_data.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/LOG_DATI_GPS_BMP_07_14_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/LOG_DATI_GPS_BMP_07_14_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
