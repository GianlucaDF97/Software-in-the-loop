 ...
 *
 * File: LOG_DATI_GPS_BMP_07_16_data.c
 *
...
P_LOG_DATI_GPS_BMP_07_16_T LOG_DATI_GPS_BMP_07_16_P = {
  /* Variable: t_AP
   * Referenced by:
   *   '<S33>/I2C Read1'
   *   '<S33>/I2C Read12'
  ...
  /* Computed Parameter: ATT_InitialCondition
  ...
  /* Computed Parameter: IMU_InitialCondition
   * Referenced by: synthesized block
   */
  0,
