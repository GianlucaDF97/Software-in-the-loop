 ...
 *
 * File: LOG_DATI_GPS_BMP_prova3.h
 *
...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_prova3_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_prova3_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LOG_DATI_GPS_BMP_prova3_COMMON_INCLUDES_
#define LOG_DATI_GPS_BMP_prova3_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                            /* LOG_DATI_GPS_BMP_prova3_COMMON_INCLUDES_ */

#include "LOG_DATI_GPS_BMP_prova3_types.h"
...
typedef struct {
  ...
  codertarget_arduinobase_int_b_T obj_l;/* '<Root>/Serial Receive1' */
...
struct P_LOG_DATI_GPS_BMP_prova3_T_ {
...
extern P_LOG_DATI_GPS_BMP_prova3_T LOG_DATI_GPS_BMP_prova3_P;

/* Block signals (default storage) */
extern B_LOG_DATI_GPS_BMP_prova3_T LOG_DATI_GPS_BMP_prova3_B;

/* Block states (default storage) */
extern DW_LOG_DATI_GPS_BMP_prova3_T LOG_DATI_GPS_BMP_prova3_DW;

/* External data declarations for dependent source files */
extern const uint16_T LOG_DATI_GPS_BMP_prova3_U16GND;/* uint16_T ground */

/* External function called from main */
extern void LOG_DATI_GPS_BMP_prova3_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void LOG_DATI_GPS_BMP_prova3_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void LOG_DATI_GPS_BMP_prova3_initialize(void);
extern void LOG_DATI_GPS_BMP_prova3_step0(void);
extern void LOG_DATI_GPS_BMP_prova3_step1(void);
extern void LOG_DATI_GPS_BMP_prova3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LOG_DATI_GPS_BMP_pro_T *const LOG_DATI_GPS_BMP_prova3_M;
 ...
 *
 * '<Root>' : 'LOG_DATI_GPS_BMP_prova3'
 * '<S1>'   : 'LOG_DATI_GPS_BMP_prova3/AIR RX'
 * '<S2>'   : 'LOG_DATI_GPS_BMP_prova3/AIR TX'
 * '<S3>'   : 'LOG_DATI_GPS_BMP_prova3/BMP_280'
 * '<S4>'   : 'LOG_DATI_GPS_BMP_prova3/Subsystem1'
 * '<S5>'   : 'LOG_DATI_GPS_BMP_prova3/Subsystem2'
 * '<S6>'   : 'LOG_DATI_GPS_BMP_prova3/AIR RX/MATLAB Function1'
 * '<S7>'   : 'LOG_DATI_GPS_BMP_prova3/AIR RX/MATLAB Function2'
 * '<S8>'   : 'LOG_DATI_GPS_BMP_prova3/AIR RX/MATLAB Function3'
 * '<S9>'   : 'LOG_DATI_GPS_BMP_prova3/AIR RX/MATLAB Function4'
 * '<S10>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Enable '
 * '<S11>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/GPS'
 * '<S12>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Heartbeat'
 * '<S13>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/IMU & Attidude'
 * '<S14>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/If_subsystem'
 * '<S15>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Radians to Degrees'
 * '<S16>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Radians to Degrees1'
 * '<S17>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Radians to Degrees2'
 * '<S18>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Servo'
 * '<S19>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/SystemStatus'
 * '<S20>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/VFR'
 * '<S21>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Waypoints'
 * '<S22>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Enable /Chart'
 * '<S23>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Enable /Chart/sendbyte'
 * '<S24>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Heartbeat/Alarm set'
 * '<S25>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/If_subsystem/Subsystem'
 * '<S26>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/If_subsystem/iflogic_function'
 * '<S27>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Servo/Conversione'
 * '<S28>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S29>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S30>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S31>'  : 'LOG_DATI_GPS_BMP_prova3/AIR TX/Waypoints/MATLAB Function'
 * '<S32>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/Dynamic rate limiter'
 * '<S33>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/Execution_loop'
 * '<S34>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/MATLAB Function'
 * '<S35>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/MATLAB Function1'
 * '<S36>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/One_time_initialization'
 * '<S37>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/Subsystem'
 * '<S38>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S39>'  : 'LOG_DATI_GPS_BMP_prova3/BMP_280/Subsystem/Subsystem1'
 * '<S40>'  : 'LOG_DATI_GPS_BMP_prova3/Subsystem2/Create_message'
 * '<S41>'  : 'LOG_DATI_GPS_BMP_prova3/Subsystem2/Subsystem'
 * '<S42>'  : 'LOG_DATI_GPS_BMP_prova3/Subsystem2/Subsystem/MATLAB Function'
 */
#endif                               /* RTW_HEADER_LOG_DATI_GPS_BMP_prova3_h_ */
