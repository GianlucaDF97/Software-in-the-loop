 ...
 *
 * File: LOG_DATI_GPS_BMP_prova_costanti.h
 *
...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LOG_DATI_GPS_BMP_prova_costanti_COMMON_INCLUDES_
#define LOG_DATI_GPS_BMP_prova_costanti_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                    /* LOG_DATI_GPS_BMP_prova_costanti_COMMON_INCLUDES_ */

#include "LOG_DATI_GPS_BMP_prova_costanti_types.h"
...
#define LOG_DATI_GPS_BMP_prova_costanti_M (LOG_DATI_GPS_BMP_prova_costa_M)
...
} B_LOG_DATI_GPS_BMP_prova_cost_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_hw_T obj; /* '<S2>/Serial Transmit1' */
  codertarget_arduinobase_in_hw_T obj_a;/* '<S23>/Serial Transmit' */
  codertarget_arduinobase_inter_T obj_d;/* '<S33>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S33>/I2C Read1' */
  codertarget_arduinobase_int_h_T obj_l;/* '<Root>/Serial Receive1' */
  ...
  uint8_T is_active_c9_LOG_DATI_GPS_BMP_p;/* '<S10>/Chart' */
  uint8_T i;                           /* '<S10>/Chart' */
...
} DW_LOG_DATI_GPS_BMP_prova_cos_T;
...
struct P_LOG_DATI_GPS_BMP_prova_cost_T_ {
  ...
  real_T Constant10_Value;             /* Expression: 0
                                        ...
                                        */
  real_T Constant11_Value;             /* Expression: 42.12345678
                                        * Referenced by: '<S2>/Constant11'
                                        */
  real_T Constant12_Value;             /* Expression: 12.123456
                                        * Referenced by: '<S2>/Constant12'
                                        */
  real_T Constant13_Value;             /* Expression: 50
                                        * Referenced by: '<S2>/Constant13'
                                        */
  real_T Constant14_Value;             /* Expression: 45
                                        * Referenced by: '<S2>/Constant14'
                                        */
  real_T Constant24_Value;             /* Expression: 30
  ...
  real_T Constant1_Value_px;           /* Expression: 1500
                                        ...
                                        */
  real_T Constant18_Value;             /* Expression: 34
...
struct tag_RTM_LOG_DATI_GPS_BMP_prov_T {
...
extern P_LOG_DATI_GPS_BMP_prova_cost_T LOG_DATI_GPS_BMP_prova_costan_P;

/* Block signals (default storage) */
extern B_LOG_DATI_GPS_BMP_prova_cost_T LOG_DATI_GPS_BMP_prova_costan_B;

/* Block states (default storage) */
extern DW_LOG_DATI_GPS_BMP_prova_cos_T LOG_DATI_GPS_BMP_prova_costa_DW;

/* External data declarations for dependent source files */
extern const uint16_T LOG_DATI_GPS_BMP_prova_costanti_U16GND;/* uint16_T ground */

/* External function called from main */
extern void LOG_DATI_GPS_BMP_prova_costanti_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void LOG_DATI_GPS_BMP_prova_costanti_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void LOG_DATI_GPS_BMP_prova_costanti_initialize(void);
extern void LOG_DATI_GPS_BMP_prova_costanti_step0(void);
extern void LOG_DATI_GPS_BMP_prova_costanti_step1(void);
extern void LOG_DATI_GPS_BMP_prova_costanti_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LOG_DATI_GPS_BMP_pro_T *const LOG_DATI_GPS_BMP_prova_costa_M;
 ...
 *
 * '<Root>' : 'LOG_DATI_GPS_BMP_prova_costanti'
 * '<S1>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR RX'
 * '<S2>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX'
 * '<S3>'   : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280'
 * '<S4>'   : 'LOG_DATI_GPS_BMP_prova_costanti/Subsystem1'
 * '<S5>'   : 'LOG_DATI_GPS_BMP_prova_costanti/Subsystem2'
 * '<S6>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR RX/MATLAB Function1'
 * '<S7>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR RX/MATLAB Function2'
 * '<S8>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR RX/MATLAB Function3'
 * '<S9>'   : 'LOG_DATI_GPS_BMP_prova_costanti/AIR RX/MATLAB Function4'
 * '<S10>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Enable '
 * '<S11>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/GPS'
 * '<S12>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Heartbeat'
 * '<S13>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/IMU & Attidude'
 * '<S14>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/If_subsystem'
 * '<S15>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Radians to Degrees'
 * '<S16>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Radians to Degrees1'
 * '<S17>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Radians to Degrees2'
 * '<S18>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Servo'
 * '<S19>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/SystemStatus'
 * '<S20>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/VFR'
 * '<S21>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Waypoints'
 * '<S22>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Enable /Chart'
 * '<S23>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Enable /Chart/sendbyte'
 * '<S24>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Heartbeat/Alarm set'
 * '<S25>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/If_subsystem/Subsystem'
 * '<S26>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/If_subsystem/iflogic_function'
 * '<S27>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Servo/Conversione'
 * '<S28>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S29>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S30>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S31>'  : 'LOG_DATI_GPS_BMP_prova_costanti/AIR TX/Waypoints/MATLAB Function'
 * '<S32>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/Dynamic rate limiter'
 * '<S33>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/Execution_loop'
 * '<S34>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/MATLAB Function'
 * '<S35>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/MATLAB Function1'
 * '<S36>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/One_time_initialization'
 * '<S37>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/Subsystem'
 * '<S38>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S39>'  : 'LOG_DATI_GPS_BMP_prova_costanti/BMP_280/Subsystem/Subsystem1'
 * '<S40>'  : 'LOG_DATI_GPS_BMP_prova_costanti/Subsystem2/Create_message'
 * '<S41>'  : 'LOG_DATI_GPS_BMP_prova_costanti/Subsystem2/Subsystem'
 * '<S42>'  : 'LOG_DATI_GPS_BMP_prova_costanti/Subsystem2/Subsystem/MATLAB Function'
 */
#endif                       /* RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_h_ */
