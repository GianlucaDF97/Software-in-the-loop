 ...
 *
 * File: LOG_DATI_GPS_BMP_prova_costanti_types.h
 *
...
#ifndef RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_types_h_
#define RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_LOG_DATI_GPS_BMP_pr_T
#define typedef_cell_wrap_LOG_DATI_GPS_BMP_pr_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_LOG_DATI_GPS_BMP_pr_T;

#endif                               /*typedef_cell_wrap_LOG_DATI_GPS_BMP_pr_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_LOG_DATI_GPS_BMP_pr_T inputVarSize;
  real_T Protocol;
  real_T port;
...
#ifndef typedef_codertarget_arduinobase_in_hw_T
#define typedef_codertarget_arduinobase_in_hw_T

typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_in_hw_T;

#endif                               /*typedef_codertarget_arduinobase_in_hw_T*/
...
typedef struct P_LOG_DATI_GPS_BMP_prova_cost_T_ P_LOG_DATI_GPS_BMP_prova_cost_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_LOG_DATI_GPS_BMP_prov_T RT_MODEL_LOG_DATI_GPS_BMP_pro_T;

#endif                 /* RTW_HEADER_LOG_DATI_GPS_BMP_prova_costanti_types_h_ */
