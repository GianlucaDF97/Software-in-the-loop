 ...
 *
 * File: Modello_Arduino_2022_data.c
 *
...
P_Modello_Arduino_2022_T Modello_Arduino_2022_P = {
  /* Variable: Kp_comp_h
  ...
  /* Mask Parameter: PIDController_Kb_a
  ...
  /* Mask Parameter: PIDController_Kt_o
  ...
  /* Computed Parameter: Out2_Y0_l
   * Referenced by: '<S444>/Out2'
   */
  0.0,

  /* Computed Parameter: Out3_Y0_b
   * Referenced by: '<S444>/Out3'
   */
  0.0,

  /* Computed Parameter: Out4_Y0_d
  ...
  /* Computed Parameter: Constant7_Value_hu
