 ...
 *
 * File: Modello_Arduino_2022_private.h
 *
...
#ifndef RTW_HEADER_Modello_Arduino_2022_private_h_
#define RTW_HEADER_Modello_Arduino_2022_private_h_
#include "rtwtypes.h"
...
extern void uMultiWordShl(const uint32_T u1[], int32_T n1, uint32_T n2, uint32_T
  y[], int32_T n);
extern void Model_EnabledSubsystem_Init(real_T *rty_u0,
  P_EnabledSubsystem_Modello_Ar_T *localP);
extern void Modello_Ar_EnabledSubsystem(uint8_T rtu_Enable, real_T rtu_Time,
  real_T *rty_u0, P_EnabledSubsystem_Modello_Ar_T *localP);
extern void Mo_ResettableSubsystem_Init(DW_ResettableSubsystem_Modell_T *localDW,
  P_ResettableSubsystem_Modello_T *localP);
extern void M_ResettableSubsystem_Reset(DW_ResettableSubsystem_Modell_T *localDW,
  P_ResettableSubsystem_Modello_T *localP);
extern real_T Modello_ResettableSubsystem(uint8_T rtu_Reset,
  DW_ResettableSubsystem_Modell_T *localDW, P_ResettableSubsystem_Modello_T
  *localP, ZCE_ResettableSubsystem_Model_T *localZCE);
extern void One_time_initializatio_Init(B_One_time_initialization_Mod_T *localB,
  DW_One_time_initialization_Mo_T *localDW, P_One_time_initialization_Mod_T
  *localP);
extern void Mod_One_time_initialization(boolean_T rtu_Enable,
  B_One_time_initialization_Mod_T *localB, DW_One_time_initialization_Mo_T
  *localDW, P_One_time_initialization_Mod_T *localP);
extern void One_time_initializatio_Term(DW_One_time_initialization_Mo_T *localDW);

#endif                          /* RTW_HEADER_Modello_Arduino_2022_private_h_ */
