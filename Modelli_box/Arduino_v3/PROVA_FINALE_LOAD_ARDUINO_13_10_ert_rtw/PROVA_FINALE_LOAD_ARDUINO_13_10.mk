###########################################################################
## Makefile generated for component 'PROVA_FINALE_LOAD_ARDUINO_13_10'. 
## 
## Makefile     : PROVA_FINALE_LOAD_ARDUINO_13_10.mk
## Generated on : Mon Oct 18 16:31:45 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PROVA_FINALE_LOAD_ARDUINO_13_10.elf
...
PRODUCT_NAME              = PROVA_FINALE_LOAD_ARDUINO_13_10
MAKEFILE                  = PROVA_FINALE_LOAD_ARDUINO_13_10.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PROVA_FINALE_LOAD_ARDUINO_13_10.elf
...
DEFINES_STANDARD = -DMODEL=PROVA_FINALE_LOAD_ARDUINO_13_10 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PROVA_FINALE_LOAD_ARDUINO_13_10.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/PROVA_FINALE_LOAD_ARDUINO_13_10.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PROVA_FINALE_LOAD_ARDUINO_13_10_data.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/PROVA_FINALE_LOAD_ARDUINO_13_10_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.o : $(START_DIR)/PROVA_FINALE_LOAD_ARDUINO_13_10_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
