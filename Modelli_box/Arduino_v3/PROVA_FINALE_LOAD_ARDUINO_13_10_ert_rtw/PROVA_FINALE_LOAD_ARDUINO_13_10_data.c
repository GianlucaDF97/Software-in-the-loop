 ...
 *
 * File: PROVA_FINALE_LOAD_ARDUINO_13_10_data.c
 *
...
P_PROVA_FINALE_LOAD_ARDUINO_1_T PROVA_FINALE_LOAD_ARDUINO_13__P = {
  /* Variable: Kp_comp_h
  ...
  /* Start of '<S554>/One_time_initialization' */
  {
  ...
  /* End of '<S554>/One_time_initialization' */
