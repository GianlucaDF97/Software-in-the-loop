 ...
 *
 * File: PROVA_FINALE_LOAD_ARDUINO_15_10_data.c
 *
...
P_PROVA_FINALE_LOAD_ARDUINO_1_T PROVA_FINALE_LOAD_ARDUINO_15__P = {
  /* Variable: Kp_comp_h
  ...
  /* Start of '<S551>/One_time_initialization' */
  {
  ...
  /* End of '<S551>/One_time_initialization' */
