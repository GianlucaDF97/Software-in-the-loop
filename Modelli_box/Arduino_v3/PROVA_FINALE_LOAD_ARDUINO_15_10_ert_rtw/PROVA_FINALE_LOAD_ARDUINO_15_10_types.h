 ...
 *
 * File: PROVA_FINALE_LOAD_ARDUINO_15_10_types.h
 *
...
#ifndef RTW_HEADER_PROVA_FINALE_LOAD_ARDUINO_15_10_types_h_
#define RTW_HEADER_PROVA_FINALE_LOAD_ARDUINO_15_10_types_h_
#include "rtwtypes.h"
...
/* Custom Type definition for MATLABSystem: '<S558>/I2C Write3' */
#include "MW_SVD.h"
...
#ifndef typedef_cell_wrap_PROVA_FINALE_LOAD_A_T
#define typedef_cell_wrap_PROVA_FINALE_LOAD_A_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_PROVA_FINALE_LOAD_A_T;

#endif                               /*typedef_cell_wrap_PROVA_FINALE_LOAD_A_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_PROVA_FINALE_LOAD_A_T inputVarSize;
  real_T Protocol;
  real_T port;
...
#ifndef typedef_codertarget_arduinobase_in_cp_T
#define typedef_codertarget_arduinobase_in_cp_T

typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_in_cp_T;

#endif                               /*typedef_codertarget_arduinobase_in_cp_T*/

/* Parameters for system: '<S408>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_PROVA_FINA_T_ P_EnabledSubsystem_PROVA_FINA_T;

/* Parameters for system: '<S408>/Resettable Subsystem' */
typedef struct P_ResettableSubsystem_PROVA_F_T_ P_ResettableSubsystem_PROVA_F_T;
...
typedef struct P_PROVA_FINALE_LOAD_ARDUINO_1_T_ P_PROVA_FINALE_LOAD_ARDUINO_1_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PROVA_FINALE_LOAD_ARD_T RT_MODEL_PROVA_FINALE_LOAD_AR_T;

#endif                 /* RTW_HEADER_PROVA_FINALE_LOAD_ARDUINO_15_10_types_h_ */
