###########################################################################
## Makefile generated for component 'TestSingoloInvio90721'. 
## 
## Makefile     : TestSingoloInvio90721.mk
## Generated on : Fri Jul 09 17:53:31 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TestSingoloInvio90721.elf
...
PRODUCT_NAME              = TestSingoloInvio90721
MAKEFILE                  = TestSingoloInvio90721.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TestSingoloInvio90721.elf
...
DEFINES_STANDARD = -DMODEL=TestSingoloInvio90721 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o TestSingoloInvio90721.o TestSingoloInvio90721_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TestSingoloInvio90721.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/TestSingoloInvio90721.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TestSingoloInvio90721_data.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/TestSingoloInvio90721_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/TestSingoloInvio90721_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
