###########################################################################
## Makefile generated for component 'a_20210406_testgpssolo'. 
## 
## Makefile     : a_20210406_testgpssolo.mk
## Generated on : Tue Apr 06 17:29:43 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/a_20210406_testgpssolo.elf
...
PRODUCT_NAME              = a_20210406_testgpssolo
MAKEFILE                  = a_20210406_testgpssolo.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/a_20210406_testgpssolo.elf
...
DEFINES_STANDARD = -DMODEL=a_20210406_testgpssolo -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o xcp_ext_work.o a_20210406_testgpssolo.o a_20210406_testgpssolo_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
a_20210406_testgpssolo.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/a_20210406_testgpssolo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


a_20210406_testgpssolo_data.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/a_20210406_testgpssolo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/a_20210406_testgpssolo_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
