 ...
 */
static __inline uint16_t mavlink_msg_obs_air_velocity_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_obs_air_velocity_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_obs_air_velocity_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_obs_air_velocity_t* obs_air_velocity)
{
...
static __inline void mavlink_msg_obs_air_velocity_send(mavlink_channel_t chan, float magnitude, float aoa, float slip)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_float(buf, 0, magnitude);
 ...
 * @return Air speed
 */
static __inline float mavlink_msg_obs_air_velocity_get_magnitude(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_obs_air_velocity_get_aoa(const mavlink_message_t* msg)
{
 ...
 * @return slip angle
 */
static __inline float mavlink_msg_obs_air_velocity_get_slip(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_obs_air_velocity_decode(const mavlink_message_t* msg, mavlink_obs_air_velocity_t* obs_air_velocity)
{
