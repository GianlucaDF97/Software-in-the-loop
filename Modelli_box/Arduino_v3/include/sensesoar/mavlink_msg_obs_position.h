 ...
 */
static __inline uint16_t mavlink_msg_obs_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_obs_position_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_obs_position_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_obs_position_t* obs_position)
{
...
static __inline void mavlink_msg_obs_position_send(mavlink_channel_t chan, int32_t lon, int32_t lat, int32_t alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_int32_t(buf, 0, lon);
 ...
 */
static __inline int32_t mavlink_msg_obs_position_get_lon(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_obs_position_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_obs_position_get_alt(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_obs_position_decode(const mavlink_message_t* msg, mavlink_obs_position_t* obs_position)
{
