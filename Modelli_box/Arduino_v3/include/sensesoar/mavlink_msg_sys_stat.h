 ...
 */
static __inline uint16_t mavlink_msg_sys_stat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_sys_stat_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_sys_stat_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_sys_stat_t* sys_stat)
{
...
static __inline void mavlink_msg_sys_stat_send(mavlink_channel_t chan, uint8_t gps, uint8_t act, uint8_t mod, uint8_t commRssi)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[4];
	_mav_put_uint8_t(buf, 0, gps);
 ...
 * @return gps status
 */
static __inline uint8_t mavlink_msg_sys_stat_get_gps(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_sys_stat_get_act(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_sys_stat_get_mod(const mavlink_message_t* msg)
{
 ...
 * @return module status
 */
static __inline uint8_t mavlink_msg_sys_stat_get_commRssi(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_sys_stat_decode(const mavlink_message_t* msg, mavlink_sys_stat_t* sys_stat)
{
