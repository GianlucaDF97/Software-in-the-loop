 ...
 */
static __inline uint16_t mavlink_msg_nav_filter_bias_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_nav_filter_bias_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_nav_filter_bias_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_nav_filter_bias_t* nav_filter_bias)
{
...
static __inline void mavlink_msg_nav_filter_bias_send(mavlink_channel_t chan, uint64_t usec, float accel_0, float accel_1, float accel_2, float gyro_0, float gyro_1, float gyro_2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[32];
	_mav_put_uint64_t(buf, 0, usec);
 ...
 */
static __inline uint64_t mavlink_msg_nav_filter_bias_get_usec(const mavlink_message_t* msg)
{
 ...
 * @return b_f[0]
 */
static __inline float mavlink_msg_nav_filter_bias_get_accel_0(const mavlink_message_t* msg)
{
 ...
 * @return b_f[1]
 */
static __inline float mavlink_msg_nav_filter_bias_get_accel_1(const mavlink_message_t* msg)
{
 ...
 * @return b_f[2]
 */
static __inline float mavlink_msg_nav_filter_bias_get_accel_2(const mavlink_message_t* msg)
{
 ...
 * @return b_f[0]
 */
static __inline float mavlink_msg_nav_filter_bias_get_gyro_0(const mavlink_message_t* msg)
{
 ...
 * @return b_f[1]
 */
static __inline float mavlink_msg_nav_filter_bias_get_gyro_1(const mavlink_message_t* msg)
{
 ...
 * @return b_f[2]
 */
static __inline float mavlink_msg_nav_filter_bias_get_gyro_2(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_nav_filter_bias_decode(const mavlink_message_t* msg, mavlink_nav_filter_bias_t* nav_filter_bias)
{
