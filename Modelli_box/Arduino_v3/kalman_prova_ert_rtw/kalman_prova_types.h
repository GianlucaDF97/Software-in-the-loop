...
#ifndef RTW_HEADER_kalman_prova_types_h_
#define RTW_HEADER_kalman_prova_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_kalman_prova_T
#define typedef_cell_wrap_kalman_prova_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_kalman_prova_T;

#endif                                 /*typedef_cell_wrap_kalman_prova_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  cell_wrap_kalman_prova_T inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct P_kalman_prova_T_ P_kalman_prova_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_kalman_prova_T RT_MODEL_kalman_prova_T;

#endif                                 /* RTW_HEADER_kalman_prova_types_h_ */
