 ...
 *
 * File: laod_arduino_2021_private.h
 *
...
#ifndef RTW_HEADER_laod_arduino_2021_private_h_
#define RTW_HEADER_laod_arduino_2021_private_h_
#include "rtwtypes.h"
...
extern void uMultiWordShl(const uint32_T u1[], int32_T n1, uint32_T n2, uint32_T
  y[], int32_T n);
extern void laod__EnabledSubsystem_Init(real_T *rty_u0,
  P_EnabledSubsystem_laod_ardui_T *localP);
extern void laod_ardui_EnabledSubsystem(uint8_T rtu_Enable, real_T rtu_Time,
  real_T *rty_u0, P_EnabledSubsystem_laod_ardui_T *localP);
extern void la_ResettableSubsystem_Init(DW_ResettableSubsystem_laod_a_T *localDW,
  P_ResettableSubsystem_laod_ar_T *localP);
extern void l_ResettableSubsystem_Reset(DW_ResettableSubsystem_laod_a_T *localDW,
  P_ResettableSubsystem_laod_ar_T *localP);
extern real_T laod_ar_ResettableSubsystem(uint8_T rtu_Reset,
  DW_ResettableSubsystem_laod_a_T *localDW, P_ResettableSubsystem_laod_ar_T
  *localP, ZCE_ResettableSubsystem_laod__T *localZCE);
extern void One_time_initializatio_Init(B_One_time_initialization_lao_T *localB,
  DW_One_time_initialization_la_T *localDW, P_One_time_initialization_lao_T
  *localP);
extern void lao_One_time_initialization(boolean_T rtu_Enable,
  B_One_time_initialization_lao_T *localB, DW_One_time_initialization_la_T
  *localDW, P_One_time_initialization_lao_T *localP);
extern void One_time_initializatio_Term(DW_One_time_initialization_la_T *localDW);

#endif                             /* RTW_HEADER_laod_arduino_2021_private_h_ */
