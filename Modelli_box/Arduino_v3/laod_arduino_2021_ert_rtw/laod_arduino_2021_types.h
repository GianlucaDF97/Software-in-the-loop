 ...
 *
 * File: laod_arduino_2021_types.h
 *
...
#ifndef RTW_HEADER_laod_arduino_2021_types_h_
#define RTW_HEADER_laod_arduino_2021_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_c_arduinodriver_ArduinoI2C_la_T
#define typedef_c_arduinodriver_ArduinoI2C_la_T

typedef struct tag_hNRvEDxDSc9X6cDQ3gk5iB c_arduinodriver_ArduinoI2C_la_T;

#endif                               /*typedef_c_arduinodriver_ArduinoI2C_la_T*/
...
struct tag_E2Q7mT7TALi8AyIFGt7NpB
{
  ...
  c_arduinodriver_ArduinoI2C_la_T I2CDriverObj;
  uint32_T BusSpeed;
...
#ifndef typedef_cell_wrap_laod_arduino_2021_T
#define typedef_cell_wrap_laod_arduino_2021_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_laod_arduino_2021_T;

#endif                                 /*typedef_cell_wrap_laod_arduino_2021_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_laod_arduino_2021_T inputVarSize;
  real_T Protocol;
  real_T port;
...
#ifndef typedef_codertarget_arduinobase_in_ky_T
#define typedef_codertarget_arduinobase_in_ky_T

typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_in_ky_T;

#endif                               /*typedef_codertarget_arduinobase_in_ky_T*/

/* Parameters for system: '<S410>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_laod_ardui_T_ P_EnabledSubsystem_laod_ardui_T;

/* Parameters for system: '<S410>/Resettable Subsystem' */
typedef struct P_ResettableSubsystem_laod_ar_T_ P_ResettableSubsystem_laod_ar_T;

/* Parameters for system: '<S569>/One_time_initialization' */
typedef struct P_One_time_initialization_lao_T_ P_One_time_initialization_lao_T;

/* Parameters (default storage) */
typedef struct P_laod_arduino_2021_T_ P_laod_arduino_2021_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_laod_arduino_2021_T RT_MODEL_laod_arduino_2021_T;

#endif                               /* RTW_HEADER_laod_arduino_2021_types_h_ */
