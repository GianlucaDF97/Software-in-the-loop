###########################################################################
## Makefile generated for Simulink model 'load_arduino_v_13'. 
## 
## Makefile     : load_arduino_v_13.mk
## Generated on : Tue Nov 05 15:07:00 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/load_arduino_v_13.elf
...
PRODUCT_NAME              = load_arduino_v_13
MAKEFILE                  = load_arduino_v_13.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/GIAMPA~1/Desktop/TESTID~1/MATLAB/AUTOPI~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/load_arduino_v_13.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/svd/include -I$(START_DIR)/load_arduino_v_13_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/variants/arduino_due_x -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/idepkgs/packages/arduino/hardware/sam/169E02~1.11/LIBRAR~1/Wire/src
...
DEFINES_ = -D_RTT_USE_SERIAL2_ -D_RTT_USE_SERIAL1_ -D_RTT_USE_SERIAL0_ -DMODEL=load_arduino_v_13 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=9 -DMW_TIMERCOUNT=13125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=57600 -D_RTT_BAUDRATE_SERIAL2_=57600 -D_RTT_BAUDRATE_SERIAL3_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=load_arduino_v_13 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialWrite.o MW_arduino_digitalio.o MW_SerialRead.o MW_arduinoI2C.o load_arduino_v_13.o load_arduino_v_13_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_zcfcn.o Mti_wrapper.o PWMinterrupt_aileron_v4_4_wrapper.o calcInputAileron.o PWMinterrupt_elevator_v4_4_wrapper.o calcInputElevator.o PWMinterrupt_goHome_wrapper.o calcInput_go_Home.o PWMinterrupt_rudder_v4_4_wrapper.o calcInputRudder.o PWMinterrupt_throttle_v4_4_wrapper.o calcInputThrottle.o Risoluzione_12bit_wrapper.o Seriale_mav_wrapper.o Servo_microseconds_alettoni_beta_3_wrapper.o Servo.o Servo_microseconds_equilibratore_beta_3_wrapper.o Servo_microseconds_manetta_beta_3_wrapper.o Servo_microseconds_timone_beta_3_wrapper.o calc_T_wrapper.o calc_p_wrapper.o receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.o send_MAVLink_v4_4_2_beta_3_HOME_wrapper.o wiring_pulse_asm.S.o dtostrf.o cortex_handlers.o hooks.o iar_calls_sam3.o itoa.o syscalls_sam3.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_shift.o abi.o IPAddress.o new.o Print.o Reset.o RingBuffer.o Stream.o UARTClass.o USARTClass.o CDC.o PluggableUSB.o USBCore.o wiring_pulse.o WMath.o WString.o watchdog.o variant.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o arm_cortex_m_multitasking.o Wire.o
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/load_arduino_v_13_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/load_arduino_v_13_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/load_arduino_v_13_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/load_arduino_v_13_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/load_arduino_v_13_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
...
arduinoARMScheduler.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoARMScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arm_cortex_m_multitasking.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arm_cortex_m_multitasking.c
	$(CC) $(CFLAGS) -o $@ $<


Wire.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/idepkgs/packages/arduino/hardware/sam/1.6.11/libraries/Wire/src/Wire.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
