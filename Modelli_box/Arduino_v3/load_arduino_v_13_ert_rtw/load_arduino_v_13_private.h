 ...
 *
 * File: load_arduino_v_13_private.h
 *
...
#ifndef RTW_HEADER_load_arduino_v_13_private_h_
#define RTW_HEADER_load_arduino_v_13_private_h_
#include "rtwtypes.h"
...
extern "C" {
  ...
  extern void Mti_Outputs_wrapper(const uint8_T *inutile,
    uint8_T *Messaggio,
    uint8_T *Control,
    const real_T *xD);
  extern void Mti_Update_wrapper(const uint8_T *inutile,
    uint8_T *Messaggio,
    uint8_T *Control,
    real_T *xD);
...
extern void load__EnabledSubsystem_Init(real_T *rty_u0,
  P_EnabledSubsystem_load_ardui_T *localP);
extern void load_ardui_EnabledSubsystem(uint8_T rtu_Enable, real_T rtu_Time,
  real_T *rty_u0, P_EnabledSubsystem_load_ardui_T *localP);
extern void lo_ResettableSubsystem_Init(DW_ResettableSubsystem_load_a_T *localDW,
  P_ResettableSubsystem_load_ar_T *localP);
extern void l_ResettableSubsystem_Reset(DW_ResettableSubsystem_load_a_T *localDW,
  P_ResettableSubsystem_load_ar_T *localP);
extern real_T load_ar_ResettableSubsystem(uint8_T rtu_Reset,
  DW_ResettableSubsystem_load_a_T *localDW, P_ResettableSubsystem_load_ar_T
  *localP, ZCE_ResettableSubsystem_load__T *localZCE);
extern void One_time_initializatio_Init(B_One_time_initialization_loa_T *localB,
  P_One_time_initialization_loa_T *localP);
extern void One_time_initializati_Start(DW_One_time_initialization_lo_T *localDW,
  P_One_time_initialization_loa_T *localP);
extern void loa_One_time_initialization(boolean_T rtu_Enable,
...
#endif                                 /* RTW_HEADER_load_arduino_v_13_private_h_ */
