...
MAKEFILE                       = loaddspace.mk
BUILDARGS                      = SKIP_TASK_CONFIGURATION=on SKIP_TASK_CONFIGURATION=on EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
...
COMPUTER                       = PCWIN64
MODEL                          = loaddspace
MODULES                        = loaddspace_data.c loaddspace_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c SImulate_messageGPS_nmea_carriage_return_wrapper.c SImulate_messageMTi_nuovo_wrapper.c outputStream_v1_wrapper.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 5
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\loaddspace_rti1006" \
	"C:\Users\lapis-dspace\Desktop\Test_dSpace\servi_test" \
