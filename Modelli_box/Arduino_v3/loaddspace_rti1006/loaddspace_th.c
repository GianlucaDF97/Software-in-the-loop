/************************ dSPACE target specific file *************************
   ...
   Include file .\loaddspace_rti1006\loaddspace_th.c :

   Task Configuration file for model : loaddspace

   RTI1006 7.15 (02-Nov-2020)/2.20
   25-Oct-2021 15:41:33
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\loaddspace_rti1006\loaddspace_th.c is for ST).
# endif
