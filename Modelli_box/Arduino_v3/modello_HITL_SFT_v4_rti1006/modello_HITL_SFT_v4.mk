...
#
#  $RCSfile: rti1006.tmf $ $Revision: 2.117 $ $Date: 2020/08/18 11:52:03CEST $
...
MAKEFILE                       = modello_HITL_SFT_v4.mk
BUILDARGS                      = SKIP_TASK_CONFIGURATION=on EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
...
COMPUTER                       = PCWIN64
MODEL                          = modello_HITL_SFT_v4
MODULES                        = modello_HITL_SFT_v4_data.c modello_HITL_SFT_v4_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c SImulate_messageGPS_nmea_carriage_return_wrapper.c SImulate_messageMTi_nuovo_wrapper.c outputStream_v1_wrapper.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 5
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\modello_HITL_SFT_v4_rti1006" \
	"C:\Users\lapis-dspace\Desktop\Nuovo_HITL2" \
	"$(MATLAB_ROOT)\extern\include" \
	"$(MATLAB_ROOT)\simulink\include" \
	"$(MATLAB_ROOT)\rtw\c\src" \
	"$(MATLAB_ROOT)\rtw\c\src\ext_mode\common" \
	"$(MATLAB_ROOT)\toolbox\aeroblks\aeroblks" \
	"$(MATLAB_ROOT)\toolbox\aero\aero\src"
...
TMP_PATH_CC += "$(MATLAB_ROOT)\toolbox\aeroblks\aeroblks"
TMP_PATH_CC += "$(MATLAB_ROOT)\toolbox\aero\aero\src"
TMP_PATH_CC += "$(MATLAB_ROOT)\rtw\c\src"
