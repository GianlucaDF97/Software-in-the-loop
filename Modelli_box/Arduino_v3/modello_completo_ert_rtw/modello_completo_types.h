...
#ifndef RTW_HEADER_modello_completo_types_h_
#define RTW_HEADER_modello_completo_types_h_
#include "rtwtypes.h"
...
/* Custom Type definition for MATLABSystem: '<S574>/I2C Write3' */
#include "MW_SVD.h"
...
#ifndef typedef_cell_wrap_modello_completo_T
#define typedef_cell_wrap_modello_completo_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_modello_completo_T;

#endif                                 /*typedef_cell_wrap_modello_completo_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_modello_completo_T inputVarSize;
  real_T Protocol;
  real_T port;
...
#ifndef typedef_codertarget_arduinobase_in_gh_T
#define typedef_codertarget_arduinobase_in_gh_T

typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_in_gh_T;

#endif                               /*typedef_codertarget_arduinobase_in_gh_T*/

/* Parameters for system: '<S408>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_modello_co_T_ P_EnabledSubsystem_modello_co_T;
...
typedef struct P_modello_completo_T_ P_modello_completo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_modello_completo_T RT_MODEL_modello_completo_T;

#endif                                /* RTW_HEADER_modello_completo_types_h_ */
