###########################################################################
## Makefile generated for component 'pitot'. 
## 
## Makefile     : pitot.mk
## Generated on : Thu Nov 25 11:45:29 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pitot.elf
...
SLIB_PATH        = C:/Users/LAPIS-~1/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pitot.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/svd/include -I$(START_DIR)/pitot_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/leonardo -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=pitot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o pitot.o pitot_data.o Risoluzione_12bit_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/pitot_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/pitot_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pitot_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pitot.o : $(START_DIR)/pitot_ert_rtw/pitot.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pitot_data.o : $(START_DIR)/pitot_ert_rtw/pitot_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
