###########################################################################
## Makefile generated for component 'provaLOG_09_28_BUONO'. 
## 
## Makefile     : provaLOG_09_28_BUONO.mk
## Generated on : Mon Oct 04 09:24:40 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/provaLOG_09_28_BUONO.elf
...
PRODUCT_NAME              = provaLOG_09_28_BUONO
MAKEFILE                  = provaLOG_09_28_BUONO.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/provaLOG_09_28_BUONO.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/svd/include -I$(START_DIR)/provaLOG_09_28_BUONO_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/variants/arduino_due_x -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/portable/packages/arduino/hardware/sam/16E81D~1.12/LIBRAR~1/SPI/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/3P778C~1.INS/ARDUIN~4.INS/LIBRAR~1/Servo/src/sam
...
DEFINES_STANDARD = -DMODEL=provaLOG_09_28_BUONO -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o MW_arduinoI2C.o provaLOG_09_28_BUONO.o provaLOG_09_28_BUONO_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Mti_wrapper.o Seriale_mav_wrapper.o calc_T_wrapper.o calc_p_wrapper.o receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.o send_MAVLink_v4_4_2_beta_3_HOME_wrapper.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


provaLOG_09_28_BUONO.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/provaLOG_09_28_BUONO.c
	$(CC) $(CFLAGS) -o "$@" "$<"


provaLOG_09_28_BUONO_data.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/provaLOG_09_28_BUONO_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/provaLOG_09_28_BUONO_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
