###########################################################################
## Makefile generated for component 'inerziale'. 
## 
## Makefile     : inerziale.mk
## Generated on : Mon Apr 26 12:39:45 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/inerziale.elf
...
PRODUCT_NAME              = inerziale
MAKEFILE                  = inerziale.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/ricca/Desktop/FLIGHT~1/drive1/LOAD_H~1/ARDUIN~2/PROVA_~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/inerziale.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/inerziale_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/$(SAM_LIB_VERSION)/variants/arduino_due_x -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include
...
DEFINES_STANDARD = -DMODEL=inerziale -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = inerziale.o inerziale_data.o updown.o ext_work.o rtiostream_utils.o Lettura_Seriale_v4_4_beta_3_wrapper.o Utility.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/inerziale_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/inerziale_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/inerziale_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/inerziale_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/inerziale_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/inerziale_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


inerziale.o : $(START_DIR)/inerziale_ert_rtw/inerziale.c
	$(CC) $(CFLAGS) -o "$@" "$<"


inerziale_data.o : $(START_DIR)/inerziale_ert_rtw/inerziale_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
Lettura_Seriale_v4_4_beta_3_wrapper.o : $(START_DIR)/Lettura_Seriale_v4_4_beta_3_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Utility.o : $(START_DIR)/Utility.c
	$(CC) $(CFLAGS) -o "$@" "$<"
