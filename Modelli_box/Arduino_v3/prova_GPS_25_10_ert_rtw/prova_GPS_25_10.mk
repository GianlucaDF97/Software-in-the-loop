###########################################################################
## Makefile generated for component 'prova_GPS_25_10'. 
## 
## Makefile     : prova_GPS_25_10.mk
## Generated on : Tue Oct 26 10:31:16 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/prova_GPS_25_10.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/prova_GPS_25_10.elf
...
DEFINES_STANDARD = -DMODEL=prova_GPS_25_10 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o prova_GPS_25_10.o prova_GPS_25_10_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Seriale_mav_wrapper.o receive_MAVLink_v4_6_beta_AL_HITL_HOME_wrapper.o send_MAVLink_v4_4_2_beta_3_HOME_wrapper.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


prova_GPS_25_10.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/prova_GPS_25_10.c
	$(CC) $(CFLAGS) -o "$@" "$<"


prova_GPS_25_10_data.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/prova_GPS_25_10_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/prova_GPS_25_10_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
