 ...
 *
 * File: prova_LOG_BMP_GPS_09_23.h
 *
...
#ifndef RTW_HEADER_prova_LOG_BMP_GPS_09_23_h_
#define RTW_HEADER_prova_LOG_BMP_GPS_09_23_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef prova_LOG_BMP_GPS_09_23_COMMON_INCLUDES_
#define prova_LOG_BMP_GPS_09_23_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                            /* prova_LOG_BMP_GPS_09_23_COMMON_INCLUDES_ */

#include "prova_LOG_BMP_GPS_09_23_types.h"
...
typedef struct {
  ...
  codertarget_arduinobase_inter_T obj_e;/* '<S40>/I2C Read8' */
  codertarget_arduinobase_inter_T obj_ef;/* '<S40>/I2C Read7' */
  codertarget_arduinobase_inter_T obj_k;/* '<S40>/I2C Read6' */
  codertarget_arduinobase_inter_T obj_a;/* '<S40>/I2C Read5' */
  codertarget_arduinobase_inter_T obj_p;/* '<S40>/I2C Read4' */
  codertarget_arduinobase_inter_T obj_f;/* '<S40>/I2C Read3' */
  codertarget_arduinobase_inter_T obj_f2;/* '<S40>/I2C Read2' */
  codertarget_arduinobase_inter_T obj_m;/* '<S40>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_i;/* '<S40>/I2C Read11' */
  codertarget_arduinobase_inter_T obj_it;/* '<S40>/I2C Read10' */
  codertarget_arduinobase_inter_T obj_fz;/* '<S40>/I2C Read1' */
  codertarget_arduinobase_inter_T obj_ag;/* '<S40>/I2C Read' */
  codertarget_arduinobase_int_o_T obj_i2;/* '<S40>/I2C Write3' */
  codertarget_arduinobase_int_o_T obj_l;/* '<S40>/I2C Write2' */
  codertarget_arduinobase_int_o_T obj_j;/* '<S40>/I2C Write1' */
...
typedef struct {
  ...
  uint8_T messaggio_d[100];            /* '<S1>/MATLAB Function4' */
  ...
  real32_T DataTypeConversion3_b;      /* '<S3>/Data Type Conversion3' */
  ...
  int32_T Add;                         /* '<S1>/Add' */
  int32_T DataTypeConversion_l[4];     /* '<S9>/Data Type Conversion' */
  int32_T DataTypeConversion1_d;       /* '<S37>/Data Type  Conversion1' */
  int32_T DataTypeConversion_i;        /* '<S37>/Data Type  Conversion' */
  int32_T SFunctionBuilder_o2_d;       /* '<S37>/S-Function Builder' */
  ...
  int16_T DataTypeConversion1_l[3];    /* '<S9>/Data Type Conversion1' */
...
} B_prova_LOG_BMP_GPS_09_23_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_in_jj_T obj; /* '<S2>/Serial Transmit1' */
  codertarget_arduinobase_in_jj_T obj_f;/* '<S21>/Serial Transmit' */
  codertarget_arduinobase_int_j_T obj_e;/* '<S22>/Serial Receive1' */
  codertarget_arduinobase_inter_T obj_ff;/* '<S37>/I2C Read12' */
  codertarget_arduinobase_inter_T obj_p;/* '<S37>/I2C Read1' */
  ...
  real_T Memory_PreviousInput_e[9];    /* '<S26>/Memory' */
  ...
  uint8_T counter_g;                   /* '<S24>/Create_message' */
  uint8_T is_active_c9_prova_LOG_BMP_GPS_;/* '<S8>/Chart' */
  uint8_T i;                           /* '<S8>/Chart' */
  uint8_T message_k[100];              /* '<S1>/MATLAB Function4' */
...
struct P_prova_LOG_BMP_GPS_09_23_T_ {
  ...
  real_T SerialTransmit1_Protocol;     /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_e;            /* Expression: 16
  ...
  real_T Constant2_Value_a;            /* Expression: 16
                                        ...
                                        */
  real_T Constant3_Value_m;            /* Expression: 8
  ...
  real_T Constant_Value_e;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_b;            /* Expression: 0.02
                                        * Referenced by: '<S29>/Constant1'
                                        */
  real_T Memory_InitialCondition_l;    /* Expression: -0.02
  ...
  real_T Constant1_Value_l[2];         /* Expression: [0 0]
                                        ...
                                        */
  real_T Constant3_Value_m1;           /* Expression: 23
                                        * Referenced by: '<S17>/Constant3'
                                        */
  real_T Gain2_Gain;                   /* Expression: 1000
                                        * Referenced by: '<S17>/Gain2'
                                        */
  real_T Constant2_Value_ac;           /* Expression: 10
  ...
  real_T alt_r_Value;                  /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_b[4];               /* Expression: [10^7;10^7;1000 ;1000]
  ...
  real_T Constant_Value_d;             /* Expression: 1
                                        ...
                                        */
  real_T Constant1_Value_l0;           /* Expression: 102000
  ...
  real_T Constant2_Value_p;            /* Expression: 10000
                                        ...
                                        */
  real_T Gain_Gain_bp;                 /* Expression: 0.01
  ...
  real_T Constant10_Value_f;           /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_lz;                 /* Expression: 180/pi
                                        * Referenced by: '<S13>/Gain'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 180/pi
                                        * Referenced by: '<S14>/Gain'
                                        */
  real_T Gain_Gain_br;                 /* Expression: 180/pi
                                        * Referenced by: '<S15>/Gain'
                                        */
  real_T Gain_Gain_m;                  /* Expression: 100
  ...
  real_T Constant3_Value_mm;           /* Expression: 1500
                                        ...
                                        */
  real_T Constant7_Value_l;            /* Expression: 9
                                        * Referenced by: '<S2>/Constant7'
                                        */
  real_T Constant8_Value_m;            /* Expression: 8
  ...
  int16_T Gain2_Gain_p;                /* Computed Parameter: Gain2_Gain_p
                                        ...
                                        */
  uint16_T Memory_InitialCondition_lq;
...
struct tag_RTM_prova_LOG_BMP_GPS_09__T {
...
extern P_prova_LOG_BMP_GPS_09_23_T prova_LOG_BMP_GPS_09_23_P;

/* Block signals (default storage) */
extern B_prova_LOG_BMP_GPS_09_23_T prova_LOG_BMP_GPS_09_23_B;

/* Block states (default storage) */
extern DW_prova_LOG_BMP_GPS_09_23_T prova_LOG_BMP_GPS_09_23_DW;

/* External data declarations for dependent source files */
extern const uint16_T prova_LOG_BMP_GPS_09_23_U16GND;/* uint16_T ground */

/* External function called from main */
extern void prova_LOG_BMP_GPS_09_23_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void prova_LOG_BMP_GPS_09_23_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void prova_LOG_BMP_GPS_09_23_initialize(void);
extern void prova_LOG_BMP_GPS_09_23_step0(void);
extern void prova_LOG_BMP_GPS_09_23_step1(void);
extern void prova_LOG_BMP_GPS_09_23_terminate(void);

/* Real-time Model object */
extern RT_MODEL_prova_LOG_BMP_GPS_09_T *const prova_LOG_BMP_GPS_09_23_M;
 ...
 *
 * '<Root>' : 'prova_LOG_BMP_GPS_09_23'
 * '<S1>'   : 'prova_LOG_BMP_GPS_09_23/AIR RX'
 * '<S2>'   : 'prova_LOG_BMP_GPS_09_23/AIR TX'
 * '<S3>'   : 'prova_LOG_BMP_GPS_09_23/BMP_280'
 * '<S4>'   : 'prova_LOG_BMP_GPS_09_23/AIR RX/MATLAB Function1'
 * '<S5>'   : 'prova_LOG_BMP_GPS_09_23/AIR RX/MATLAB Function2'
 * '<S6>'   : 'prova_LOG_BMP_GPS_09_23/AIR RX/MATLAB Function3'
 * '<S7>'   : 'prova_LOG_BMP_GPS_09_23/AIR RX/MATLAB Function4'
 * '<S8>'   : 'prova_LOG_BMP_GPS_09_23/AIR TX/Enable '
 * '<S9>'   : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS'
 * '<S10>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Heartbeat'
 * '<S11>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/IMU & Attidude'
 * '<S12>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/If_subsystem'
 * '<S13>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Radians to Degrees'
 * '<S14>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Radians to Degrees1'
 * '<S15>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Radians to Degrees2'
 * '<S16>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Servo'
 * '<S17>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/SystemStatus'
 * '<S18>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/VFR'
 * '<S19>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Waypoints'
 * '<S20>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Enable /Chart'
 * '<S21>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Enable /Chart/sendbyte'
 * '<S22>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus'
 * '<S23>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus/Subsystem1'
 * '<S24>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus/Subsystem2'
 * '<S25>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus/Subsystem2/Create_message'
 * '<S26>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus/Subsystem2/Subsystem'
 * '<S27>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/GPS/GPS_Venus/Subsystem2/Subsystem/MATLAB Function'
 * '<S28>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Heartbeat/Alarm set'
 * '<S29>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/If_subsystem/Subsystem'
 * '<S30>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/If_subsystem/iflogic_function'
 * '<S31>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Servo/Conversione'
 * '<S32>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S33>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S34>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S35>'  : 'prova_LOG_BMP_GPS_09_23/AIR TX/Waypoints/MATLAB Function'
 * '<S36>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/Dynamic rate limiter'
 * '<S37>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/Execution_loop'
 * '<S38>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/MATLAB Function'
 * '<S39>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/MATLAB Function1'
 * '<S40>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/One_time_initialization'
 * '<S41>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/Subsystem'
 * '<S42>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S43>'  : 'prova_LOG_BMP_GPS_09_23/BMP_280/Subsystem/Subsystem1'
 */
#endif                               /* RTW_HEADER_prova_LOG_BMP_GPS_09_23_h_ */
