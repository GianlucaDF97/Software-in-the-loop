...
#ifndef RTW_HEADER_provaseriale_types_h_
#define RTW_HEADER_provaseriale_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_provaseriale_T
#define typedef_cell_wrap_provaseriale_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_provaseriale_T;

#endif                                 /*typedef_cell_wrap_provaseriale_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  cell_wrap_provaseriale_T inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct P_provaseriale_T_ P_provaseriale_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_provaseriale_T RT_MODEL_provaseriale_T;

#endif                                 /* RTW_HEADER_provaseriale_types_h_ */
