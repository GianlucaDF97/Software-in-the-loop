###########################################################################
## Makefile generated for component 'ricezione_gps_8_10'. 
## 
## Makefile     : ricezione_gps_8_10.mk
## Generated on : Fri Oct 08 18:36:43 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ricezione_gps_8_10.elf
...
PRODUCT_NAME              = ricezione_gps_8_10
MAKEFILE                  = ricezione_gps_8_10.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ricezione_gps_8_10.elf
...
DEFINES_STANDARD = -DMODEL=ricezione_gps_8_10 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o ricezione_gps_8_10.o ricezione_gps_8_10_data.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ricezione_gps_8_10.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/ricezione_gps_8_10.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ricezione_gps_8_10_data.o : $(START_DIR)/ricezione_gps_8_10_ert_rtw/ricezione_gps_8_10_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
