...
#ifndef RTW_HEADER_telemetria_BMP280_h_
#define RTW_HEADER_telemetria_BMP280_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef telemetria_BMP280_COMMON_INCLUDES_
#define telemetria_BMP280_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "MW_I2C.h"
#endif                                 /* telemetria_BMP280_COMMON_INCLUDES_ */

#include "telemetria_BMP280_types.h"
...
} B_One_time_initialization_tel_T;
...
} DW_One_time_initialization_te_T;
...
typedef struct {
  ...
  B_One_time_initialization_tel_T One_time_initialization;/* '<S3>/One_time_initialization' */
} B_telemetria_BMP280_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_int_f_T obj; /* '<S18>/Serial Transmit' */
  ...
  uint8_T is_active_c9_telemetria_BMP280;/* '<S8>/Chart' */
  uint8_T i;                           /* '<S8>/Chart' */
  ...
  DW_One_time_initialization_te_T One_time_initialization;/* '<S3>/One_time_initialization' */
} DW_telemetria_BMP280_T;

/* Parameters for system: '<S3>/One_time_initialization' */
struct P_One_time_initialization_tel_T_ {
...
struct P_telemetria_BMP280_T_ {
  ...
  uint8_T Typefixed_wingAutopilotgeneric_[2];
                           ...
                           */
  P_One_time_initialization_tel_T One_time_initialization;/* '<S3>/One_time_initialization' */
};

/* Real-time Model Data Structure */
struct tag_RTM_telemetria_BMP280_T {
...
extern P_telemetria_BMP280_T telemetria_BMP280_P;

/* Block signals (default storage) */
extern B_telemetria_BMP280_T telemetria_BMP280_B;

/* Block states (default storage) */
extern DW_telemetria_BMP280_T telemetria_BMP280_DW;

/* External data declarations for dependent source files */
extern const uint16_T telemetria_BMP280_U16GND;/* uint16_T ground */

/* External function called from main */
extern void telemetria_BMP280_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void telemetria_BMP280_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void telemetria_BMP280_initialize(void);
extern void telemetria_BMP280_step0(void);
extern void telemetria_BMP280_step1(void);
extern void telemetria_BMP280_terminate(void);

/* Real-time Model object */
extern RT_MODEL_telemetria_BMP280_T *const telemetria_BMP280_M;
 ...
 *
 * '<Root>' : 'telemetria_BMP280'
 * '<S1>'   : 'telemetria_BMP280/AIR RX'
 * '<S2>'   : 'telemetria_BMP280/AIR TX'
 * '<S3>'   : 'telemetria_BMP280/BMP_280'
 * '<S4>'   : 'telemetria_BMP280/AIR RX/MATLAB Function1'
 * '<S5>'   : 'telemetria_BMP280/AIR RX/MATLAB Function2'
 * '<S6>'   : 'telemetria_BMP280/AIR RX/MATLAB Function3'
 * '<S7>'   : 'telemetria_BMP280/AIR RX/MATLAB Function4'
 * '<S8>'   : 'telemetria_BMP280/AIR TX/Enable '
 * '<S9>'   : 'telemetria_BMP280/AIR TX/GPS'
 * '<S10>'  : 'telemetria_BMP280/AIR TX/Heartbeat'
 * '<S11>'  : 'telemetria_BMP280/AIR TX/IMU & Attidude'
 * '<S12>'  : 'telemetria_BMP280/AIR TX/If_subsystem'
 * '<S13>'  : 'telemetria_BMP280/AIR TX/Servo'
 * '<S14>'  : 'telemetria_BMP280/AIR TX/SystemStatus'
 * '<S15>'  : 'telemetria_BMP280/AIR TX/VFR'
 * '<S16>'  : 'telemetria_BMP280/AIR TX/Waypoints'
 * '<S17>'  : 'telemetria_BMP280/AIR TX/Enable /Chart'
 * '<S18>'  : 'telemetria_BMP280/AIR TX/Enable /Chart/sendbyte'
 * '<S19>'  : 'telemetria_BMP280/AIR TX/Heartbeat/Alarm set'
 * '<S20>'  : 'telemetria_BMP280/AIR TX/If_subsystem/Subsystem'
 * '<S21>'  : 'telemetria_BMP280/AIR TX/If_subsystem/iflogic_function'
 * '<S22>'  : 'telemetria_BMP280/AIR TX/Servo/Conversione'
 * '<S23>'  : 'telemetria_BMP280/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S24>'  : 'telemetria_BMP280/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S25>'  : 'telemetria_BMP280/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S26>'  : 'telemetria_BMP280/AIR TX/Waypoints/MATLAB Function'
 * '<S27>'  : 'telemetria_BMP280/BMP_280/Dynamic rate limiter'
 * '<S28>'  : 'telemetria_BMP280/BMP_280/Execution_loop'
 * '<S29>'  : 'telemetria_BMP280/BMP_280/MATLAB Function'
 * '<S30>'  : 'telemetria_BMP280/BMP_280/MATLAB Function1'
 * '<S31>'  : 'telemetria_BMP280/BMP_280/One_time_initialization'
 * '<S32>'  : 'telemetria_BMP280/BMP_280/Subsystem'
 * '<S33>'  : 'telemetria_BMP280/BMP_280/Dynamic rate limiter/Saturation Dynamic'
 * '<S34>'  : 'telemetria_BMP280/BMP_280/Subsystem/Subsystem1'
 */
#endif                                 /* RTW_HEADER_telemetria_BMP280_h_ */
