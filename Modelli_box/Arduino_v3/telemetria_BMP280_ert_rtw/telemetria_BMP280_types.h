 ...
 *
 * File: telemetria_BMP280_types.h
 *
...
#ifndef RTW_HEADER_telemetria_BMP280_types_h_
#define RTW_HEADER_telemetria_BMP280_types_h_
#include "rtwtypes.h"

/* Model Code Variants */

/* Custom Type definition for MATLABSystem: '<S31>/I2C Write3' */
#include "MW_SVD.h"
...
typedef struct tag_hNRvEDxDSc9X6cDQ3gk5iB c_arduinodriver_ArduinoI2C_te_T;
...
#ifndef typedef_cell_wrap_telemetria_BMP280_T
#define typedef_cell_wrap_telemetria_BMP280_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_telemetria_BMP280_T;

#endif                                 /*typedef_cell_wrap_telemetria_BMP280_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_telemetria_BMP280_T inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_int_f_T;

#endif                               /*typedef_codertarget_arduinobase_int_f_T*/

/* Parameters for system: '<S3>/One_time_initialization' */
typedef struct P_One_time_initialization_tel_T_ P_One_time_initialization_tel_T;

/* Parameters (default storage) */
typedef struct P_telemetria_BMP280_T_ P_telemetria_BMP280_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_telemetria_BMP280_T RT_MODEL_telemetria_BMP280_T;

#endif                               /* RTW_HEADER_telemetria_BMP280_types_h_ */
