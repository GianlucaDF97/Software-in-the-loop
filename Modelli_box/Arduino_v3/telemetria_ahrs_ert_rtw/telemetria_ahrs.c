 ...
 * C/C++ source code generated on : Fri Oct 22 15:57:17 2021
 *
...
void telemetria_ahrs_step0(void)       /* Sample time: [0.02s, 0.0s] */
{
  ...
  int32_T status;
  int32_T x;
  real32_T rtb_Gain1_aj;
  real32_T rtb_Gain1_e;
  real32_T rtb_Gain1_gi;
  real32_T tmp;
  uint32_T qY;
  uint16_T x_0;
  uint16_T z;
  ...
  Seriale_mav_Outputs_wrapper(&telemetria_ahrs_P.Constant1_Value_fl,
    ...
    &telemetria_ahrs_DW.SFunctionBuilder_DSTATE_f);
  ...
  switch (caso) {
   case 1:
    telemetria_ahrs_B.RateTransition = telemetria_ahrs_B.poss_254[(int32_T)
      telemetria_ahrs_B.num_254 - 1];
    if (telemetria_ahrs_B.RateTransition == 100.0) {
      ...
      telemetria_ahrs_DW.Interr_parz = true;
               ...
               (telemetria_ahrs_B.RateTransition + 1.0) - 1] <= 100) {
      ...
      if (g == telemetria_ahrs_B.SFunctionBuilder_o2) {
        telemetria_ahrs_B.num_254 = rt_roundd_snf
          (telemetria_ahrs_B.RateTransition);
        ...
        f = (int32_T)(telemetria_ahrs_B.SFunctionBuilder_o1[(int32_T)
                      (telemetria_ahrs_B.RateTransition + 1.0) - 1] + 7U);
        if ((uint32_T)f > 255U) {
          f = 255;
        }

        telemetria_ahrs_B.RateTransition = rt_roundd_snf
          (telemetria_ahrs_B.RateTransition + (real_T)f);
        if (telemetria_ahrs_B.RateTransition < 256.0) {
          if (telemetria_ahrs_B.RateTransition >= 0.0) {
            c = (uint8_T)telemetria_ahrs_B.RateTransition;
          } else {
            c = 0U;
          }
        } else {
        ...
        if (f > telemetria_ahrs_B.SFunctionBuilder_o2) {
          ...
          if (telemetria_ahrs_B.RateTransition > telemetria_ahrs_DW.mess_len) {
            g = 0;
            f = 0;
          } else {
            g = (int32_T)telemetria_ahrs_B.RateTransition - 1;
          ...
          f = (int32_T)(telemetria_ahrs_B.SFunctionBuilder_o1[(int32_T)
                        (telemetria_ahrs_B.RateTransition + 1.0) - 1] + 8U);
          if ((uint32_T)f > 255U) {
            f = 255;
          }

          telemetria_ahrs_B.RateTransition = rt_roundd_snf((real_T)f -
            telemetria_ahrs_DW.mess_len);
          if (telemetria_ahrs_B.RateTransition < 256.0) {
            if (telemetria_ahrs_B.RateTransition >= 0.0) {
              telemetria_ahrs_DW.counter_e = (uint8_T)
                telemetria_ahrs_B.RateTransition;
            } else {
              telemetria_ahrs_DW.counter_e = 0U;
            }
   ...
   case 2:
    ...
    if (telemetria_ahrs_ifWhileCond(telemetria_ahrs_B.x)) {
      telemetria_ahrs_B.RateTransition = rt_roundd_snf
        (telemetria_ahrs_DW.mess_len + 1.0);
      if (telemetria_ahrs_B.RateTransition < 256.0) {
        if (telemetria_ahrs_B.RateTransition >= 0.0) {
          c = (uint8_T)telemetria_ahrs_B.RateTransition;
        } else {
      ...
      telemetria_ahrs_B.RateTransition = rt_roundd_snf
        (telemetria_ahrs_DW.mess_len + (real_T)telemetria_ahrs_DW.counter_e);
      if (telemetria_ahrs_B.RateTransition < 256.0) {
        if (telemetria_ahrs_B.RateTransition >= 0.0) {
          counter = (uint8_T)telemetria_ahrs_B.RateTransition;
        } else {
          counter = 0U;
        }
      } else {
   ...
   case 3:
    telemetria_ahrs_B.RateTransition = rt_roundd_snf(telemetria_ahrs_DW.mess_len
      + 1.0);
    if (telemetria_ahrs_B.RateTransition < 256.0) {
      if (telemetria_ahrs_B.RateTransition >= 0.0) {
        c = (uint8_T)telemetria_ahrs_B.RateTransition;
    ...
    telemetria_ahrs_B.RateTransition = rt_roundd_snf(telemetria_ahrs_DW.mess_len
      + (real_T)telemetria_ahrs_DW.counter_e);
    if (telemetria_ahrs_B.RateTransition < 256.0) {
      if (telemetria_ahrs_B.RateTransition >= 0.0) {
        counter = (uint8_T)telemetria_ahrs_B.RateTransition;
      } else {
    ...
    if (telemetria_ahrs_B.SFunctionBuilder_o1[f] <= 100) {
      ...
      if (g == caso) {
        telemetria_ahrs_B.RateTransition = rt_roundd_snf
          (telemetria_ahrs_B.poss_254[(int32_T)telemetria_ahrs_B.num_254 - 1]);
        if (telemetria_ahrs_B.RateTransition < 256.0) {
          if (telemetria_ahrs_B.RateTransition >= 0.0) {
            counter = (uint8_T)telemetria_ahrs_B.RateTransition;
          } else {
   ...
   case 4:
    if (telemetria_ahrs_B.SFunctionBuilder_o1[(int32_T)
      ...
      telemetria_ahrs_B.RateTransition = rt_roundd_snf
        (telemetria_ahrs_B.poss_254[0] + (real_T)f);
      if (telemetria_ahrs_B.RateTransition < 256.0) {
        if (telemetria_ahrs_B.RateTransition >= 0.0) {
          c = (uint8_T)telemetria_ahrs_B.RateTransition;
        } else {
    ...
    if ((telemetria_ahrs_B.SFunctionBuilder_o1[(int32_T)
      ...
      telemetria_ahrs_B.RateTransition = rt_roundd_snf((real_T)
      ...
      if (telemetria_ahrs_B.RateTransition < 2.147483648E+9) {
        if (telemetria_ahrs_B.RateTransition >= -2.147483648E+9) {
          g = (int32_T)telemetria_ahrs_B.RateTransition;
        } else {
          g = MIN_int32_T;
        }
      } else {
      ...
      if (g == f) {
        ...
        telemetria_ahrs_B.RateTransition = rt_roundd_snf
          (telemetria_ahrs_B.poss_254[1] + (real_T)f);
        if (telemetria_ahrs_B.RateTransition < 256.0) {
          if (telemetria_ahrs_B.RateTransition >= 0.0) {
            c = (uint8_T)telemetria_ahrs_B.RateTransition;
          } else {
        ...
        if (telemetria_ahrs_B.RateTransition < 2.147483648E+9) {
          if (telemetria_ahrs_B.RateTransition >= -2.147483648E+9) {
            f = (int32_T)telemetria_ahrs_B.RateTransition;
          } else {
            f = MIN_int32_T;
          }
        } else {
  ...
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_DW.RateTransition_Buffer0;
  ...
  if ((telemetria_ahrs_DW.Memory1_PreviousInput == 1.0) ||
    ...
    telemetria_ahrs_B.iflogic = 30U;
             ...
             (telemetria_ahrs_B.RateTransition == 2.0)) {
    telemetria_ahrs_B.iflogic = 33U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             (telemetria_ahrs_B.RateTransition == 6.0)) {
    telemetria_ahrs_B.iflogic = 34U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             (telemetria_ahrs_B.RateTransition == 0.0)) {
    telemetria_ahrs_B.iflogic = 0U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             ((telemetria_ahrs_B.RateTransition == 1.0) ||
              (telemetria_ahrs_B.RateTransition == 5.0) ||
              (telemetria_ahrs_B.RateTransition == 9.0))) {
    telemetria_ahrs_B.iflogic = 1U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             ((telemetria_ahrs_B.RateTransition == 3.0) ||
              (telemetria_ahrs_B.RateTransition == 8.0))) {
    telemetria_ahrs_B.iflogic = 74U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             (telemetria_ahrs_B.RateTransition == 7.0)) {
    telemetria_ahrs_B.iflogic = 36U;
  } else if ((telemetria_ahrs_DW.Memory1_PreviousInput == 0.0) &&
             (telemetria_ahrs_B.RateTransition == 4.0)) {
  ...
  /* Gain: '<S11>/Gain' */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain_Gain *
    telemetria_ahrs_DW.Memory_PreviousInput;

  /* DataTypeConversion: '<S11>/Data Type Conversion3' */
  if (telemetria_ahrs_B.RateTransition < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.RateTransition);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.RateTransition);
  }

  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
    telemetria_ahrs_B.RateTransition = fmod(telemetria_ahrs_B.RateTransition,
      4.294967296E+9);
  }

  /* DataTypeConversion: '<S11>/Data Type Conversion3' */
  telemetria_ahrs_B.DataTypeConversion3 = telemetria_ahrs_B.RateTransition < 0.0
    ? (uint32_T)-(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition :
    (uint32_T)telemetria_ahrs_B.RateTransition;
   ...
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Gain_Gain_l *
   ...
   *  Gain: '<S13>/Gain'
   */
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[0] =
    telemetria_ahrs_P.loaduint16_Value;
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[1] = (uint16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   *  MATLAB Function: '<S1>/MATLAB Function1'
   */
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[2] = (uint16_T)qY;
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[3] =
    telemetria_ahrs_B.SFunction_o11[6];
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[4] =
    telemetria_ahrs_B.SFunction_o11[2];
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[5] =
    telemetria_ahrs_P._Value;

  /* Gain: '<S13>/Gain2' incorporates:
   *  Constant: '<S13>/Constant3'
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Gain2_Gain *
   ...
   *  Gain: '<S13>/Gain2'
   */
  telemetria_ahrs_B.Gain1 = (int16_T)(((telemetria_ahrs_B.RateTransition < 0.0 ?
    (int32_T)(int16_T)-(int16_T)(uint16_T)-telemetria_ahrs_B.RateTransition :
    (int32_T)(int16_T)(uint16_T)telemetria_ahrs_B.RateTransition) *
    telemetria_ahrs_P.Gain1_Gain_i) >> 18);

  /* DataTypeConversion: '<S13>/Data Type Conversion3' incorporates:
   *  Constant: '<S13>/Constant4'
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant4_Value);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
  ...
  telemetria_ahrs_B.B_Remaining = (int8_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(int8_T)-(int8_T)(uint8_T)-telemetria_ahrs_B.RateTransition :
    (int32_T)(int8_T)(uint8_T)telemetria_ahrs_B.RateTransition);

  /* DataTypeConversion: '<S9>/Data Type Conversion' incorporates:
   *  Constant: '<S9>/Constant'
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant_Value_d);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
  ...
  telemetria_ahrs_B.DataTypeConversion = telemetria_ahrs_B.RateTransition < 0.0 ?
    (uint32_T)-(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition : (uint32_T)
    telemetria_ahrs_B.RateTransition;

  /* DataTypeConversion: '<S13>/Data Type Conversion4' incorporates:
   *  Constant: '<S13>/Constant1'
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant1_Value_e[0]);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
   ...
   */
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[6] = (uint16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   *  Constant: '<S13>/Constant1'
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant1_Value_e[1]);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
   ...
   *  DataTypeConversion: '<S13>/Data Type Conversion4'
   */
  telemetria_ahrs_B.TmpSignalConversionAtSFunctio_d[7] = (uint16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
  ...
  /* Gain: '<S24>/Gain1' */
  rtb_Gain1_aj = telemetria_ahrs_P.Gain1_Gain_b *
    telemetria_ahrs_B.ByteReversal[3];

  /* Gain: '<S25>/Gain1' */
  rtb_Gain1_gi = telemetria_ahrs_P.Gain1_Gain_h *
    telemetria_ahrs_B.ByteReversal[4];

  /* Gain: '<S26>/Gain1' */
  rtb_Gain1_e = telemetria_ahrs_P.Gain1_Gain_a * telemetria_ahrs_B.ByteReversal
    [5];

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(rtb_Gain1_aj);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[3] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(rtb_Gain1_gi);
  if (rtIsNaNF(tmp) || rtIsInfF(tmp)) {
    tmp = 0.0F;
  } else {
    tmp = (real32_T)fmod(tmp, 65536.0);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[4] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(rtb_Gain1_e);
  if (rtIsNaNF(tmp) || rtIsInfF(tmp)) {
    tmp = 0.0F;
  } else {
    tmp = (real32_T)fmod(tmp, 65536.0);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[5] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[0] =
    telemetria_ahrs_P.Gain1_Gain_e * telemetria_ahrs_B.ByteReversal[6];
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[1] =
    telemetria_ahrs_P.Gain1_Gain_k * telemetria_ahrs_B.ByteReversal[7];
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[2] =
    telemetria_ahrs_P.Gain1_Gain_p * telemetria_ahrs_B.ByteReversal[8];
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[3] = rtb_Gain1_aj;
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[4] = rtb_Gain1_gi;
  telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[5] = rtb_Gain1_e;

  /* Gain: '<S8>/Gain' incorporates:
   *  Constant: '<S8>/Lat Simulated'
   *  Gain: '<S18>/Gain'
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain_Gain_e *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_c[0] = telemetria_ahrs_B.RateTransition <
    0.0 ? -(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition : (int32_T)
    (uint32_T)telemetria_ahrs_B.RateTransition;
   ...
   *  Gain: '<S19>/Gain'
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain_Gain_m *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_c[1] = telemetria_ahrs_B.RateTransition <
    0.0 ? -(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition : (int32_T)
    (uint32_T)telemetria_ahrs_B.RateTransition;
   ...
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain_Gain_h[2] *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_c[2] = telemetria_ahrs_B.RateTransition <
    0.0 ? -(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition : (int32_T)
    (uint32_T)telemetria_ahrs_B.RateTransition;
   ...
   *  Constant: '<S8>/alt_r'
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain_Gain_h[3] *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_c[3] = telemetria_ahrs_B.RateTransition <
    0.0 ? -(int32_T)(uint32_T)-telemetria_ahrs_B.RateTransition : (int32_T)
    (uint32_T)telemetria_ahrs_B.RateTransition;
   ...
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain1_Gain *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion1' */
  telemetria_ahrs_B.DataTypeConversion1_m[0] = (int16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(int16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(int16_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion1' */
  telemetria_ahrs_B.DataTypeConversion1_m[1] = (int16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(int16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(int16_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion1' */
  telemetria_ahrs_B.DataTypeConversion1_m[2] = (int16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(int16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(int16_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   */
  telemetria_ahrs_B.RateTransition = telemetria_ahrs_P.Gain2_Gain_h *
  ...
  /* DataTypeConversion: '<S8>/Data Type Conversion2' */
  telemetria_ahrs_B.DataTypeConversion2 = (uint16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   */
  telemetria_ahrs_B.RateTransition = floor
    (telemetria_ahrs_P.Headingsimulated_Value_g);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
  ...
  telemetria_ahrs_B.DataTypeConversion4 = (int16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(int16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(int16_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Rpmsimulated_Value);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
  ...
  telemetria_ahrs_B.DataTypeConversion5 = (uint16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(uint16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
   ...
   */
  telemetria_ahrs_B.Gain2 = telemetria_ahrs_P.Gain2_Gain_p *
  ...
  if (telemetria_ahrs_P.Constant_Value_l < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_P.Constant_Value_l);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant_Value_l);
  }
  ...
  telemetria_ahrs_B.Heading[0] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);

  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  if (telemetria_ahrs_B.Gain2 < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.Gain2);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.Gain2);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[1] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  if (telemetria_ahrs_B.num_254 < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.num_254);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.num_254);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[2] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);
  ...
  if (telemetria_ahrs_B.Sum1 < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.Sum1);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.Sum1);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[3] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);
  ...
  if (telemetria_ahrs_B.Sum2 < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.Sum2);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.Sum2);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[4] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(telemetria_ahrs_B.ByteReversal[0]);
  if (rtIsNaNF(tmp) || rtIsInfF(tmp)) {
    tmp = 0.0F;
  } else {
    tmp = (real32_T)fmod(tmp, 65536.0);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[0] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[6] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  if (telemetria_ahrs_P.Constant1_Value_f[0] < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_P.Constant1_Value_f
      [0]);
  } else {
    telemetria_ahrs_B.RateTransition = floor
      (telemetria_ahrs_P.Constant1_Value_f[0]);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[5] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(telemetria_ahrs_B.ByteReversal[1]);
  if (rtIsNaNF(tmp) || rtIsInfF(tmp)) {
    tmp = 0.0F;
  } else {
    tmp = (real32_T)fmod(tmp, 65536.0);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[1] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[7] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  if (telemetria_ahrs_P.Constant1_Value_f[1] < 0.0) {
    ...
    telemetria_ahrs_B.RateTransition = floor
      (telemetria_ahrs_P.Constant1_Value_f[1]);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[6] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);

  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  tmp = (real32_T)floor(telemetria_ahrs_B.ByteReversal[2]);
  if (rtIsNaNF(tmp) || rtIsInfF(tmp)) {
    tmp = 0.0F;
  } else {
    tmp = (real32_T)fmod(tmp, 65536.0);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[2] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  /* DataTypeConversion: '<S10>/Data Type Conversion' */
  telemetria_ahrs_B.DataTypeConversion_j[8] = (int16_T)(tmp < 0.0F ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-tmp : (int32_T)(int16_T)(uint16_T)tmp);
  ...
  if (telemetria_ahrs_P.Constant1_Value_f[2] < 0.0) {
    ...
    telemetria_ahrs_B.RateTransition = floor
      (telemetria_ahrs_P.Constant1_Value_f[2]);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[7] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);
  ...
  if (telemetria_ahrs_B.PatohPa1 < 0.0) {
    telemetria_ahrs_B.RateTransition = ceil(telemetria_ahrs_B.PatohPa1);
  } else {
    telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_B.PatohPa1);
  }
  ...
  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  telemetria_ahrs_B.Heading[8] = (uint16_T)(telemetria_ahrs_B.RateTransition <
    0.0 ? (int32_T)(uint16_T)-(int16_T)(uint16_T)
    -telemetria_ahrs_B.RateTransition : (int32_T)(uint16_T)
    telemetria_ahrs_B.RateTransition);
   ...
   */
  telemetria_ahrs_B.RateTransition = floor(telemetria_ahrs_P.Constant3_Value_f);
  if (rtIsNaN(telemetria_ahrs_B.RateTransition) || rtIsInf
      (telemetria_ahrs_B.RateTransition)) {
    telemetria_ahrs_B.RateTransition = 0.0;
  } else {
  ...
  telemetria_ahrs_B.DataTypeConversion2_b = (int16_T)
    (telemetria_ahrs_B.RateTransition < 0.0 ? (int32_T)(int16_T)-(int16_T)
     (uint16_T)-telemetria_ahrs_B.RateTransition : (int32_T)(int16_T)(uint16_T)
     telemetria_ahrs_B.RateTransition);
  ...
  send_MAVLink_v4_4_2_beta_3_HOME_Outputs_wrapper(&telemetria_ahrs_B.iflogic,
    ...
    &telemetria_ahrs_B.TmpSignalConversionAtSFunctio_m[0],
    &telemetria_ahrs_B.DataTypeConversion_j[0],
    &telemetria_ahrs_B.TmpSignalConversionAtSFunctionI[0],
...
void telemetria_ahrs_initialize(void)
{
...

  {
    ...
    Mti_Start_wrapper(&telemetria_ahrs_DW.SFunctionBuilder_DSTATE);
    ...
    /* S-Function Block: <S1>/S-Function Builder */
    {
...

      {
        int_T i1;
        for (i1=0; i1 < 1; i1++) {
          telemetria_ahrs_DW.SFunctionBuilder_DSTATE_f = initVector[0];
        }
      }
    }
