...
#ifndef RTW_HEADER_telemetria_ahrs_h_
#define RTW_HEADER_telemetria_ahrs_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef telemetria_ahrs_COMMON_INCLUDES_
#define telemetria_ahrs_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "MW_SerialRead.h"
#include "MW_SerialWrite.h"
#endif                                 /* telemetria_ahrs_COMMON_INCLUDES_ */

#include "telemetria_ahrs_types.h"
...
typedef struct {
  ...
  real_T poss_254[3];
  uint16_T TmpSignalConversionAtSFunctio_d[8];/* '<S2>/SystemStatus' */
  ...
  real32_T TmpSignalConversionAtSFunctionI[6];/* '<S2>/IMU & Attidude' */
  ...
  int16_T DataTypeConversion_j[9];     /* '<S10>/Data Type Conversion' */
  int16_T DataTypeConversion1_m[3];    /* '<S8>/Data Type Conversion1' */
  int16_T DataTypeConversion4;         /* '<S14>/Data Type Conversion4' */
...
typedef struct {
  ...
  uint8_T is_active_c9_telemetria_ahrs;/* '<S7>/Chart' */
  uint8_T i;                           /* '<S7>/Chart' */
...
} DW_telemetria_ahrs_T;

/* Parameters (default storage) */
struct P_telemetria_ahrs_T_ {
...
struct tag_RTM_telemetria_ahrs_T {
...
extern P_telemetria_ahrs_T telemetria_ahrs_P;

/* Block signals (default storage) */
extern B_telemetria_ahrs_T telemetria_ahrs_B;

/* Block states (default storage) */
extern DW_telemetria_ahrs_T telemetria_ahrs_DW;

/* External data declarations for dependent source files */
extern const uint16_T telemetria_ahrs_U16GND;/* uint16_T ground */

/* External function called from main */
extern void telemetria_ahrs_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void telemetria_ahrs_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void telemetria_ahrs_initialize(void);
extern void telemetria_ahrs_step0(void);
extern void telemetria_ahrs_step1(void);
extern void telemetria_ahrs_terminate(void);

/* Real-time Model object */
extern RT_MODEL_telemetria_ahrs_T *const telemetria_ahrs_M;
 ...
 *
 * '<Root>' : 'telemetria_ahrs'
 * '<S1>'   : 'telemetria_ahrs/AIR RX'
 * '<S2>'   : 'telemetria_ahrs/AIR TX'
 * '<S3>'   : 'telemetria_ahrs/AIR RX/MATLAB Function1'
 * '<S4>'   : 'telemetria_ahrs/AIR RX/MATLAB Function2'
 * '<S5>'   : 'telemetria_ahrs/AIR RX/MATLAB Function3'
 * '<S6>'   : 'telemetria_ahrs/AIR RX/MATLAB Function4'
 * '<S7>'   : 'telemetria_ahrs/AIR TX/Enable '
 * '<S8>'   : 'telemetria_ahrs/AIR TX/GPS'
 * '<S9>'   : 'telemetria_ahrs/AIR TX/Heartbeat'
 * '<S10>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude'
 * '<S11>'  : 'telemetria_ahrs/AIR TX/If_subsystem'
 * '<S12>'  : 'telemetria_ahrs/AIR TX/Servo'
 * '<S13>'  : 'telemetria_ahrs/AIR TX/SystemStatus'
 * '<S14>'  : 'telemetria_ahrs/AIR TX/VFR'
 * '<S15>'  : 'telemetria_ahrs/AIR TX/Waypoints'
 * '<S16>'  : 'telemetria_ahrs/AIR TX/Enable /Chart'
 * '<S17>'  : 'telemetria_ahrs/AIR TX/Enable /Chart/sendbyte'
 * '<S18>'  : 'telemetria_ahrs/AIR TX/GPS/Radians to Degrees'
 * '<S19>'  : 'telemetria_ahrs/AIR TX/GPS/Radians to Degrees1'
 * '<S20>'  : 'telemetria_ahrs/AIR TX/Heartbeat/Alarm set'
 * '<S21>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians'
 * '<S22>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians1'
 * '<S23>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians2'
 * '<S24>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians3'
 * '<S25>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians4'
 * '<S26>'  : 'telemetria_ahrs/AIR TX/IMU & Attidude/Degrees to Radians5'
 * '<S27>'  : 'telemetria_ahrs/AIR TX/If_subsystem/Subsystem'
 * '<S28>'  : 'telemetria_ahrs/AIR TX/If_subsystem/iflogic_function'
 * '<S29>'  : 'telemetria_ahrs/AIR TX/Servo/Conversione'
 * '<S30>'  : 'telemetria_ahrs/AIR TX/Servo/Conversione/Radians to Degrees1'
 * '<S31>'  : 'telemetria_ahrs/AIR TX/Servo/Conversione/Radians to Degrees2'
 * '<S32>'  : 'telemetria_ahrs/AIR TX/Servo/Conversione/Radians to Degrees3'
 * '<S33>'  : 'telemetria_ahrs/AIR TX/Waypoints/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_telemetria_ahrs_h_ */
