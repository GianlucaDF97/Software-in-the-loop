...
#ifndef RTW_HEADER_telemetria_ahrs_types_h_
#define RTW_HEADER_telemetria_ahrs_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_telemetria_ahrs_T
#define typedef_cell_wrap_telemetria_ahrs_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_telemetria_ahrs_T;

#endif                                 /*typedef_cell_wrap_telemetria_ahrs_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  cell_wrap_telemetria_ahrs_T inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct P_telemetria_ahrs_T_ P_telemetria_ahrs_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_telemetria_ahrs_T RT_MODEL_telemetria_ahrs_T;

#endif                                 /* RTW_HEADER_telemetria_ahrs_types_h_ */
