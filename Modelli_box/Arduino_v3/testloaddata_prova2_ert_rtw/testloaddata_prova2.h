...
#ifndef RTW_HEADER_testloaddata_prova2_h_
#define RTW_HEADER_testloaddata_prova2_h_
#include <stddef.h>
#include <string.h>
#include <float.h>
#ifndef testloaddata_prova2_COMMON_INCLUDES_
#define testloaddata_prova2_COMMON_INCLUDES_
#include <stdlib.h>
#include "rtwtypes.h"
#include "rt_logging.h"
#include "MW_gpio.h"
#include "MW_SCI.h"
#endif                                /* testloaddata_prova2_COMMON_INCLUDES_ */

#include "testloaddata_prova2_types.h"
...
typedef struct {
  ...
  uint16_T ByteUnpack_o4[10];          /* '<S16>/Byte Unpack' */
...
} DW_testloaddata_prova2_T;

/* Parameters (default storage) */
struct P_testloaddata_prova2_T_ {
...
struct tag_RTM_testloaddata_prova2_T {
...
extern P_testloaddata_prova2_T testloaddata_prova2_P;

/* Block signals (default storage) */
extern B_testloaddata_prova2_T testloaddata_prova2_B;

/* Block states (default storage) */
extern DW_testloaddata_prova2_T testloaddata_prova2_DW;

/* Model entry point functions */
extern void testloaddata_prova2_initialize(void);
extern void testloaddata_prova2_step(void);
extern void testloaddata_prova2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_testloaddata_prova2_T *const testloaddata_prova2_M;
 ...
 *
 * '<Root>' : 'testloaddata_prova2'
 * '<S1>'   : 'testloaddata_prova2/ 2'
 * '<S2>'   : 'testloaddata_prova2/GPIO Read1'
 * '<S3>'   : 'testloaddata_prova2/MATLAB Function1'
 * '<S4>'   : 'testloaddata_prova2/RX Sensori1'
 * '<S5>'   : 'testloaddata_prova2/RX Sensori1/Degrees to Radians'
 * '<S6>'   : 'testloaddata_prova2/RX Sensori1/Degrees to Radians1'
 * '<S7>'   : 'testloaddata_prova2/RX Sensori1/Degrees to Radians2'
 * '<S8>'   : 'testloaddata_prova2/RX Sensori1/Degrees to Radians3'
 * '<S9>'   : 'testloaddata_prova2/RX Sensori1/Degrees to Radians4'
 * '<S10>'  : 'testloaddata_prova2/RX Sensori1/Degrees to Radians5'
 * '<S11>'  : 'testloaddata_prova2/RX Sensori1/Degrees to Radians6'
 * '<S12>'  : 'testloaddata_prova2/RX Sensori1/Degrees to Radians7'
 * '<S13>'  : 'testloaddata_prova2/RX Sensori1/Degrees to Radians8'
 * '<S14>'  : 'testloaddata_prova2/RX Sensori1/Subsystem'
 * '<S15>'  : 'testloaddata_prova2/RX Sensori1/Subsystem/MATLAB Function'
 * '<S16>'  : 'testloaddata_prova2/RX Sensori1/Subsystem/Subsystem'
 */
#endif                                 /* RTW_HEADER_testloaddata_prova2_h_ */
