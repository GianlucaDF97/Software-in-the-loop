...
extern void uMultiWordShl(const uint32_T u1[], int32_T n1, uint32_T n2, uint32_T
  y[], int32_T n);
extern void un_One_time_initialization_Init(B_One_time_initialization_unt_T
  *localB, DW_One_time_initialization_un_T *localDW,
  P_One_time_initialization_unt_T *localP);
extern void untitle_One_time_initialization(boolean_T rtu_Enable,
  B_One_time_initialization_unt_T *localB, DW_One_time_initialization_un_T
  *localDW, P_One_time_initialization_unt_T *localP);
extern void un_One_time_initialization_Term(DW_One_time_initialization_un_T
  *localDW);
