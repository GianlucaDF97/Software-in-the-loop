...
/* Custom Type definition for MATLABSystem: '<S27>/I2C Write3' */
#include "MW_SVD.h"
...
typedef struct tag_hNRvEDxDSc9X6cDQ3gk5iB c_arduinodriver_ArduinoI2C_un_T;
...
#ifndef typedef_cell_wrap_untitled1_T
#define typedef_cell_wrap_untitled1_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_untitled1_T;

#endif                                 /*typedef_cell_wrap_untitled1_T*/
...
struct tag_VxMdwqNJNRwRcuNs0czZ4C
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_untitled1_T inputVarSize;
  real_T Protocol;
  real_T port;
...
#ifndef typedef_codertarget_arduinobase_in_lq_T
#define typedef_codertarget_arduinobase_in_lq_T

typedef struct tag_VxMdwqNJNRwRcuNs0czZ4C codertarget_arduinobase_in_lq_T;

#endif                               /*typedef_codertarget_arduinobase_in_lq_T*/

/* Parameters for system: '<S20>/One_time_initialization' */
typedef struct P_One_time_initialization_unt_T_ P_One_time_initialization_unt_T;
