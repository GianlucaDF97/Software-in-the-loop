 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Apr 28 17:02:18 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Risoluzione_12bit
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Risoluzione_12bit_Outputs_wrapper(xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Risoluzione_12bit_Update_wrapper(xD);
