 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 30 13:44:13 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME calc_T
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        dig_T1
...
{
    const uint16_T *dig_T1 = (uint16_T *) ssGetInputPortRealSignal(S, 0);
    const int16_T *dig_T2 = (int16_T *) ssGetInputPortRealSignal(S, 1);
    const int16_T *dig_T3 = (int16_T *) ssGetInputPortRealSignal(S, 2);
    const int32_T *adc_T = (int32_T *) ssGetInputPortRealSignal(S, 3);
    real32_T *T = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    int32_T *t_fine = (int32_T *) ssGetOutputPortRealSignal(S, 1);

    calc_T_Outputs_wrapper(dig_T1, dig_T2, dig_T3, adc_T, T, t_fine);
