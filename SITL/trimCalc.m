...
V_cruise = input('inserire un valore desiderato per V_cruise: ');

h0=input('inserire la quota desiderata: ');   %calcolo della densità a partire da una quota impostata dall'utente
sim('Density_height_SITL.slx');
