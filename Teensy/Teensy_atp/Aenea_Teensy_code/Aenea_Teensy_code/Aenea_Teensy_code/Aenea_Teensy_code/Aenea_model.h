...
// Block states (default storage) for system '<S425>/Enabled '
typedef struct {
  boolean_T Enabled_MODE;              // '<S425>/Enabled '
...
typedef struct {
  ...
  real_T abs_ManualThrottle;           // '<S417>/Abs3'
  real_T Gain_h;                       // '<S33>/Gain'
  real_T Sum_fb;                       // '<S350>/Sum'
  real_T Saturation_o;                 // '<S348>/Saturation'
...
typedef struct {
  ...
  real_T Tf;                           // '<S411>/MATLAB Function1'
  ...
  DW_ResettableSubsystem_Aene_c_T ResettableSubsystem_p0;// '<S440>/Resettable Subsystem' 
  DW_Enabled_Aenea_model_d_T Enabled_h;// '<S440>/Enabled '
  DW_ResettableSubsystem_Aene_c_T ResettableSubsystem_h;// '<S439>/Resettable Subsystem' 
  DW_Enabled_Aenea_model_T Enabled_n;  // '<S439>/Enabled '
  ...
  DW_Enabled_Aenea_model_d_T Enabled_o;// '<S426>/Enabled '
  DW_ResettableSubsystem_Aene_c_T ResettableSubsystem_i;// '<S425>/Resettable Subsystem' 
  DW_Enabled_Aenea_model_T Enabled;    // '<S425>/Enabled '
...
//  Block '<S599>/Gain' : Eliminated nontunable gain of 1
