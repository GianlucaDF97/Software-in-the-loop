/*
 * File: send_MAVLink_v4_4_2_beta_3_HOME_sfun.cpp
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 11 17:56:25 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME send_MAVLink_v4_4_2_beta_3_HOME_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *P_val = (real_T *) ssGetInputPortRealSignal(S, 4);
    const uint16_T *WP_info = (uint16_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *WP_param = (real_T *) ssGetInputPortRealSignal(S, 6);
    ...
    const real_T *attitude = (real_T *) ssGetInputPortRealSignal(S, 14);
    const real_T *lat_long_alt = (real_T *) ssGetInputPortRealSignal(S, 15);
    const int16_T *velGPS = (int16_T *) ssGetInputPortRealSignal(S, 16);
    const uint16_T *hdg = (uint16_T *) ssGetInputPortRealSignal(S, 17);
    const real_T *VFR_speed = (real_T *) ssGetInputPortRealSignal(S, 18);
    ...
    const real_T *P_refer = (real_T *) ssGetInputPortRealSignal(S, 23);
    const uint8_T *Cal_alt = (uint8_T *) ssGetInputPortRealSignal(S, 24);
    const real_T *T_0 = (real_T *) ssGetInputPortRealSignal(S, 25);
    const uint8_T *T_int = (uint8_T *) ssGetInputPortRealSignal(S, 26);
    const real_T *P_RAW = (real_T *) ssGetInputPortRealSignal(S, 27);
    const real_T *deltaP_RAW = (real_T *) ssGetInputPortRealSignal(S, 28);
