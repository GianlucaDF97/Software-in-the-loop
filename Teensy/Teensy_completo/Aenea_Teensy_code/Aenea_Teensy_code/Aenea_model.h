...
typedef struct {
  ...
  real_T dv1[11];
  real_T UnitDelay[9];                 // '<S570>/Unit Delay'
  real_T DataTypeConversion1_c[9];     // '<S5>/Data Type Conversion1'
  real_T aterra_tmp[9];
  char_T b_data[64];
  char_T sfull[64];
  int32_T ipiv[11];
  real32_T ByteUnpack_o2[9];           // '<S570>/Byte Unpack'
  real32_T ByteReversal[9];            // '<S570>/Byte Reversal'
  real_T x_new[4];
  real_T aterra[3];
  char_T hex_checksum_data[17];
  boolean_T NOT[14];                   // '<S559>/NOT'
  uint16_T WP_info_in[6];
  real_T Lat;                          // '<S568>/S-Function Builder'
  real_T Long;                         // '<S568>/S-Function Builder'
  real_T V;                            // '<S568>/S-Function Builder'
  real_T quota;                        // '<S568>/S-Function Builder'
  real_T heading;                      // '<S568>/S-Function Builder'
  real_T SFunctionBuilder_o6;          // '<S568>/S-Function Builder'
  real_T SFunctionBuilder;             // '<S571>/S-Function Builder'
  ...
  real_T UkYk1;                        // '<S572>/Difference Inputs1'
  ...
  real32_T DataTypeConversion3_p;      // '<S573>/Data Type Conversion3'
  real32_T SFunctionBuilder_o1;        // '<S573>/S-Function Builder'
  real32_T SFunctionBuilder_o2;        // '<S573>/S-Function Builder'
  real32_T SFunctionBuilder_o3;        // '<S573>/S-Function Builder'
  ...
  uint8_T SFunctionBuilder1[41];       // '<S570>/S-Function Builder1'
  uint8_T ByteUnpack_o1[4];            // '<S570>/Byte Unpack'
  uint8_T ByteUnpack_o3;               // '<S570>/Byte Unpack'
  ...
  uint8_T SFunctionBuilder_i;          // '<S2>/S-Function Builder'
  uint8_T Mex_out[41];                 // '<S570>/MATLAB Function1'
  uint8_T iflogic;                     // '<S16>/iflogic_function'
  uint8_T mess_out[100];               // '<S1>/MATLAB Function2'
  boolean_T SFunctionBuilder_o7;       // '<S568>/S-Function Builder'
  boolean_T Compare;                   // '<S566>/Compare'
  boolean_T HitCrossing;               // '<S247>/Hit  Crossing'
} B_Aenea_model_T;

// Block states (default storage) for system '<Root>'
typedef struct {
  real_T UnitDelay_DSTATE[9];          // '<S570>/Unit Delay'
  real_T UnitDelay1_DSTATE;            // '<S565>/Unit Delay1'
  real_T UnitDelay_DSTATE_c;           // '<S555>/Unit Delay'
  real_T Delay_DSTATE[6];              // '<S568>/Delay'
  ...
  real_T Delay_DSTATE_a;               // '<S246>/Delay'
  ...
  uint8_T UnitDelay1_DSTATE_b[41];     // '<S570>/Unit Delay1'
  uint8_T Output_DSTATE;               // '<S567>/Output'
...
//  Block '<S578>/FixPt Data Type Duplicate' : Unused code path elimination
//  Block '<S579>/FixPt Data Type Duplicate1' : Unused code path elimination
...
//  Block '<S589>/Divide' : Unused code path elimination
//  Block '<S589>/Multiply' : Unused code path elimination
//  Block '<S589>/Sum' : Unused code path elimination
//  Block '<S589>/Sum1' : Unused code path elimination
//  Block '<S589>/Sum2' : Unused code path elimination
//  Block '<S589>/Sum3' : Unused code path elimination
...
//  Block '<S591>/Constant' : Unused code path elimination
//  Block '<S591>/Constant1' : Unused code path elimination
//  Block '<S591>/Divide' : Unused code path elimination
//  Block '<S591>/Multiply' : Unused code path elimination
//  Block '<S591>/Sum' : Unused code path elimination
//  Block '<S591>/Sum1' : Unused code path elimination
//  Block '<S591>/Sum2' : Unused code path elimination
//  Block '<S591>/Sum3' : Unused code path elimination
...
//  Block '<S5>/Manual Switch2' : Eliminated due to constant selection input
//  Block '<S5>/Manual Switch3' : Eliminated due to constant selection input
//  Block '<S585>/Gain' : Eliminated nontunable gain of 1
...
//  '<S566>' : 'Aenea_model/Misure Sensori/Compare To Constant'
//  '<S567>' : 'Aenea_model/Misure Sensori/Counter Limited'
//  '<S568>' : 'Aenea_model/Misure Sensori/GPS_Venus'
//  '<S569>' : 'Aenea_model/Misure Sensori/Lidar'
//  '<S570>' : 'Aenea_model/Misure Sensori/MTi'
//  '<S571>' : 'Aenea_model/Misure Sensori/Pitot'
//  '<S572>' : 'Aenea_model/Misure Sensori/BMP_280/Dynamic rate limiter'
//  '<S573>' : 'Aenea_model/Misure Sensori/BMP_280/Execution_loop'
//  '<S574>' : 'Aenea_model/Misure Sensori/BMP_280/MATLAB Function'
//  '<S575>' : 'Aenea_model/Misure Sensori/BMP_280/Subsystem'
//  '<S576>' : 'Aenea_model/Misure Sensori/BMP_280/Dynamic rate limiter/Saturation Dynamic'
//  '<S577>' : 'Aenea_model/Misure Sensori/BMP_280/Subsystem/Subsystem1'
//  '<S578>' : 'Aenea_model/Misure Sensori/Counter Limited/Increment Real World'
//  '<S579>' : 'Aenea_model/Misure Sensori/Counter Limited/Wrap To Zero'
//  '<S580>' : 'Aenea_model/Misure Sensori/GPS_Venus/Subsystem2'
//  '<S581>' : 'Aenea_model/Misure Sensori/MTi/MATLAB Function1'
//  '<S582>' : 'Aenea_model/RADIOCOMANDO/AILERON'
//  '<S583>' : 'Aenea_model/RADIOCOMANDO/AILERON1'
//  '<S584>' : 'Aenea_model/RADIOCOMANDO/ELEVATOR'
//  '<S585>' : 'Aenea_model/RADIOCOMANDO/ELEVATOR1'
//  '<S586>' : 'Aenea_model/RADIOCOMANDO/RUDDER'
//  '<S587>' : 'Aenea_model/RADIOCOMANDO/THROTTLE'
//  '<S588>' : 'Aenea_model/Servi/AILERON1'
//  '<S589>' : 'Aenea_model/Servi/RUDDER6'
//  '<S590>' : 'Aenea_model/Servi/THROTTLE1'
//  '<S591>' : 'Aenea_model/Servi/elevator'
