 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Nov 17 11:55:46 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MavLink_Send_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        mavlink_buf_out
#define INPUT_0_WIDTH         1
#define INPUT_DIMS_0_COL      264
...
/* Input Port  1 */
#define IN_PORT_1_NAME        mavlink_buf_len
...
{
    const uint8_T *mavlink_buf_out = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    const uint16_T *mavlink_buf_len = (uint16_T *) ssGetInputPortRealSignal(S, 1);

    MavLink_Send_sfun_Outputs_wrapper(mavlink_buf_out, mavlink_buf_len);
