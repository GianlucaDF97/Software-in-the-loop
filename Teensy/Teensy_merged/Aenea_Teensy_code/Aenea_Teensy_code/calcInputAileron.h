...
#define AILERON_SIGNAL_IN 37 // INTERRUPT 2 = DIGITAL PIN 21 - use the interrupt number in attachInterrupt
#define AILERON_SIGNAL_IN_PIN 37 // INTERRUPT 2 = DIGITAL PIN 21 - use the PIN number in digitalRead
