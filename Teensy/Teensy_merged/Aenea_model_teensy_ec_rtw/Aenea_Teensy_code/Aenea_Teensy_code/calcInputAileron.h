...
#define AILERON_SIGNAL_IN 23 // INTERRUPT 2 = DIGITAL PIN 21 - use the interrupt number in attachInterrupt
#define AILERON_SIGNAL_IN_PIN 23 // INTERRUPT 2 = DIGITAL PIN 21 - use the PIN number in digitalRead
