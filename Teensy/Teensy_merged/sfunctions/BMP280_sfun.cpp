 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Nov 08 12:55:39 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME BMP280_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        h_ref
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       BaroPressure
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       BaroAlt
...
{
    const real32_T *h_ref = (real32_T *) ssGetInputPortRealSignal(S, 0);
    real32_T *OAT = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *BaroPressure = (real32_T *) ssGetOutputPortRealSignal(S, 1);
    real32_T *BaroAlt = (real32_T *) ssGetOutputPortRealSignal(S, 2);

    BMP280_sfun_Outputs_wrapper(h_ref, OAT, BaroPressure, BaroAlt);
