 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 11 18:19:29 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Servo_alettoni_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    Servo_alettoni_sfun_Start_wrapper(xD);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Servo_alettoni_sfun_Outputs_wrapper(tau, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Servo_alettoni_sfun_Update_wrapper(tau, xD);
