/*
 * File: Servo_equilibratore_sfun.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 11 18:16:41 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Servo_equilibratore_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    Servo_equilibratore_sfun_Start_wrapper(xD);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Servo_equilibratore_sfun_Outputs_wrapper(tau, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Servo_equilibratore_sfun_Update_wrapper(tau, xD);
