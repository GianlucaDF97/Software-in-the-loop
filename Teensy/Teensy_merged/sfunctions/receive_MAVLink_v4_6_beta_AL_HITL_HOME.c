/*
 * File: receive_MAVLink_v4_6_beta_AL_HITL_HOME.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Sep 02 18:39:47 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME receive_MAVLink_v4_6_beta_AL_HITL_HOME
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void receive_MAVLink_v4_6_beta_AL_HITL_HOME_Outputs_wrapper(const uint8_T *bytes_in,
