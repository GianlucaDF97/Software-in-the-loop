...
#define ELEVATOR_SIGNAL_IN 22 // INTERRUPT 1 = DIGITAL PIN 3 - use the interrupt number in attachInterrupt
#define ELEVATOR_SIGNAL_IN_PIN 22 // INTERRUPT 1 = DIGITAL PIN 3 - use the PIN number in digitalRead
