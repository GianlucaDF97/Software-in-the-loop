 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Apr 21 11:58:38 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Servo_manetta_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    Servo_manetta_sfun_Start_wrapper(xD);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Servo_manetta_sfun_Outputs_wrapper(tau, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Servo_manetta_sfun_Update_wrapper(tau, xD);
