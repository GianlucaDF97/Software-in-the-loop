 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Dec 23 13:11:14 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME blink_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        clock
...
{
    const boolean_T *clock = (boolean_T *) ssGetInputPortRealSignal(S, 0);

    blink_sfun_Outputs_wrapper(clock);
