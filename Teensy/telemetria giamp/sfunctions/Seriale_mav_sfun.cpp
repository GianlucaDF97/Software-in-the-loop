 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Nov 17 11:54:21 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Seriale_mav_sfun
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Seriale_mav_sfun_Outputs_wrapper(Messaggio, serial_available);
